...
public class ecru_BlockCropsRapeseed extends BlockCrops {

    @SideOnly(Side.CLIENT)
    private IIcon[] iconArray;

    public ecru_BlockCropsRapeseed() {
        func_149675_a(true);
    ...
    protected Item func_149866_i() {
        return mod_ecru_MapleTree.Item_rapeSeeds;
    }
    ...
    public void func_149651_a(IIconRegister par1IconRegister) {
        ...
        for (int i = 0; i < this.iconArray.length; i++) {
            this.iconArray[i] = par1IconRegister.func_94245_a("mapletree:rapeseed_" + i);
        }
    }
