...
public class ecru_BlockCropsFennel extends ecru_BlockCropsBase {
    ...
    protected Item func_149866_i() {
        return mod_ecru_MapleTree.Item_fennelSeed;
    }
    ...
    public void func_149651_a(IIconRegister par1IconRegister) {
        ...
        for (int i = 0; i < this.iconArray.length; i++) {
            this.iconArray[i] = par1IconRegister.func_94245_a("mapletree:fennel_" + i);
        }
    }
