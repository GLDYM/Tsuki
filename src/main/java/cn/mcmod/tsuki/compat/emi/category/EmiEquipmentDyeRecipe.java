...
public class EmiEquipmentDyeRecipe extends EmiCraftingRecipe {
    private EmiEquipmentDyeRecipe(List<EmiIngredient> input, EmiStack output, net.minecraft.resources.ResourceLocation id) {
        super(input, output, id, true);
    }

    public static EmiEquipmentDyeRecipe of(net.minecraft.resources.ResourceLocation id, EquipmentDyeDisplay.Entry entry) {
