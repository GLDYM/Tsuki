...
public class ecru_ItemSunDryingBonito extends Item {
    private String itemName;
    private final int COUNT = 2400;

    public ecru_ItemSunDryingBonito(String str) {
        func_77627_a(true);
        func_77656_e(0);
    ...
    public void func_150895_a(Item par1, CreativeTabs par2CreativeTabs, List itemList) {
        ...
        nbt.func_74768_a("countTimerMax", 2400);
    ...
    public boolean func_77648_a(ItemStack itemstack, EntityPlayer entityplayer, World world, int i, int j, int k, int l, float par8, float par9, float par10) {
        if (!world.field_72995_K) {
            ...
            if (tile != null) {
                ...
                tile.setItemIn(new ItemStack(mod_ecru_MapleTree.Item_foodstuff, 1, 24));
                tile.setItemOut(new ItemStack(mod_ecru_MapleTree.Item_foodsDish, 9, 34));
