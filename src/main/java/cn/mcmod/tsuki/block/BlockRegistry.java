...
import cn.mcmod.tsuki.level.tree.MapleTreeGrower;
import cn.mcmod.tsuki.level.tree.TsukiTreeFeatures;
import cn.mcmod.tsuki.level.tree.TsukiTreeGrower;
...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> SAKURA_LEAVES = BLOCKS.register("sakuraleaves",
            () -> new TsukiLeavesBlock(Block.Properties.copy(Blocks.OAK_LEAVES).strength(0.2F).randomTicks()
    ...
    public static final RegistryObject<Block> MAPLE_SAPLING_RED = BLOCKS.register("maple_sapling_red",
            () -> sapling(new MapleTreeGrower(TsukiTreeFeatures.MAPLE_RED_KEY, TsukiTreeFeatures.FANCY_MAPLE_RED_KEY)));
    public static final RegistryObject<Block> MAPLE_SAPLING_GREEN = BLOCKS.register("maple_sapling_green",
            () -> sapling(new MapleTreeGrower(TsukiTreeFeatures.MAPLE_GREEN_KEY, TsukiTreeFeatures.FANCY_MAPLE_GREEN_KEY)));
    public static final RegistryObject<Block> MAPLE_SAPLING_YELLOW = BLOCKS.register("maple_sapling_yellow",
            () -> sapling(new MapleTreeGrower(TsukiTreeFeatures.MAPLE_YELLOW_KEY, TsukiTreeFeatures.FANCY_MAPLE_YELLOW_KEY)));
    public static final RegistryObject<Block> MAPLE_SAPLING_ORANGE = BLOCKS.register("maple_sapling_orange",
            () -> sapling(new MapleTreeGrower(TsukiTreeFeatures.MAPLE_ORANGE_KEY, TsukiTreeFeatures.FANCY_MAPLE_ORANGE_KEY)));
