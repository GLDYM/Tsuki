...
public class FluidRegistry {
    ...
    public static final DeferredHolder<Fluid, FlowingFluid> COCOA_LIQUEUR_FLOWING = FLUIDS.register(
            "cocoa_liqueur_flowing",
    ...
    private static final BaseFlowingFluid.Properties DOBUROKU_PROP = createProp(DOBUROKU, DOBUROKU_FLOWING,
            FluidTypeRegistry.DOBUROKU, FluidBlockRegistry.DOBUROKU_BLOCK, BucketItemRegistry.DOBUROKU_BUCKET);

    private static final BaseFlowingFluid.Properties SAKE_PROP = createProp(SAKE, SAKE_FLOWING, FluidTypeRegistry.SAKE,
            FluidBlockRegistry.SAKE_BLOCK, BucketItemRegistry.SAKE_BUCKET);

    private static final BaseFlowingFluid.Properties SHOUCHU_PROP = createProp(SHOUCHU, SHOUCHU_FLOWING,
            FluidTypeRegistry.SHOUCHU, FluidBlockRegistry.SHOUCHU_BLOCK, BucketItemRegistry.SHOUCHU_BUCKET);

    private static final BaseFlowingFluid.Properties BEER_PROP = createProp(BEER, BEER_FLOWING, FluidTypeRegistry.BEER,
            FluidBlockRegistry.BEER_BLOCK, BucketItemRegistry.BEER_BUCKET);

    private static final BaseFlowingFluid.Properties BRANDY_PROP = createProp(BRANDY, BRANDY_FLOWING,
            FluidTypeRegistry.BRANDY, FluidBlockRegistry.BRANDY_BLOCK, BucketItemRegistry.BRANDY_BUCKET);

    private static final BaseFlowingFluid.Properties WHISKEY_PROP = createProp(WHISKEY, WHISKEY_FLOWING,
            FluidTypeRegistry.WHISKEY, FluidBlockRegistry.WHISKEY_BLOCK, BucketItemRegistry.WHISKEY_BUCKET);

    private static final BaseFlowingFluid.Properties RUM_PROP = createProp(RUM, RUM_FLOWING, FluidTypeRegistry.RUM,
            FluidBlockRegistry.RUM_BLOCK, BucketItemRegistry.RUM_BUCKET);

    private static final BaseFlowingFluid.Properties RED_WINE_PROP = createProp(RED_WINE, RED_WINE_FLOWING,
            FluidTypeRegistry.RED_WINE, FluidBlockRegistry.RED_WINE_BLOCK, BucketItemRegistry.RED_WINE_BUCKET);

    private static final BaseFlowingFluid.Properties WHITE_WINE_PROP = createProp(WHITE_WINE, WHITE_WINE_FLOWING,
            FluidTypeRegistry.WHITE_WINE, FluidBlockRegistry.WHITE_WINE_BLOCK, BucketItemRegistry.WHITE_WINE_BUCKET);

    private static final BaseFlowingFluid.Properties CHAMPAGNE_PROP = createProp(CHAMPAGNE, CHAMPAGNE_FLOWING,
            FluidTypeRegistry.CHAMPAGNE, FluidBlockRegistry.CHAMPAGNE_BLOCK, BucketItemRegistry.CHAMPAGNE_BUCKET);

    private static final BaseFlowingFluid.Properties VODKA_PROP = createProp(VODKA, VODKA_FLOWING,
            FluidTypeRegistry.VODKA, FluidBlockRegistry.VODKA_BLOCK, BucketItemRegistry.VODKA_BUCKET);

    private static final BaseFlowingFluid.Properties LIQUEUR_PROP = createProp(LIQUEUR, LIQUEUR_FLOWING,
            FluidTypeRegistry.LIQUEUR, FluidBlockRegistry.LIQUEUR_BLOCK, BucketItemRegistry.LIQUEUR_BUCKET);

    private static final BaseFlowingFluid.Properties COCOA_LIQUEUR_PROP = createProp(COCOA_LIQUEUR,
            COCOA_LIQUEUR_FLOWING, FluidTypeRegistry.COCOA_LIQUEUR, FluidBlockRegistry.COCOA_LIQUEUR_BLOCK,
            BucketItemRegistry.COCOA_LIQUEUR_BUCKET);

    private static final BaseFlowingFluid.Properties GIN_PROP = createProp(GIN, GIN_FLOWING, FluidTypeRegistry.GIN,
            FluidBlockRegistry.GIN_BLOCK, BucketItemRegistry.GIN_BUCKET);

    private static final BaseFlowingFluid.Properties TEQUILA_PROP = createProp(TEQUILA, TEQUILA_FLOWING,
            FluidTypeRegistry.TEQUILA, FluidBlockRegistry.TEQUILA_BLOCK, BucketItemRegistry.TEQUILA_BUCKET);
    ...
    private static BaseFlowingFluid.Properties createProp(
        ...
        UnaryOperator<BaseFlowingFluid.Properties> blockProperties = p -> p.block(block).bucket(bucket)
