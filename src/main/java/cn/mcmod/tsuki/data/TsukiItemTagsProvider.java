...
public class TsukiItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags(Provider provider) {
        ...
        this.tag(TsukiItemTags.ADVANCEMENT_RICE_DISHES).add(
        ...
        this.tag(TsukiItemTags.ADVANCEMENT_NOODLE_DISHES).add(
        ...
        DrinkRegistry.WINE_BOTTLES.values().forEach(bottle -> this.tag(TsukiItemTags.ADVANCEMENT_BASE_WINE_BOTTLES)
                .add(bottle.get()));
