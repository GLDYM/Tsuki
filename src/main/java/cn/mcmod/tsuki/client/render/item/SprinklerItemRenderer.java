...
public class SprinklerItemRenderer extends GeoItemRenderer<SprinklerItem> {
    ...
    private static class Model extends GeoModel<SprinklerItem> {
        ...
        @Override
        public ResourceLocation getModelResource(SprinklerItem item) {
            return item.getModelResource();
        }

        @Override
        public ResourceLocation getTextureResource(SprinklerItem item) {
            return TEXTURE;
        }

        @Override
        public ResourceLocation getAnimationResource(SprinklerItem item) {
            return ANIMATION;
        }
