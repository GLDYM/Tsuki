...
public class ecru_BlockOreFlowerIron extends BlockContainer {
    ...
    public ecru_BlockOreFlowerIron() {
    ...
    public boolean func_149742_c(World world, int i, int j, int k) {
        if ((world.func_147439_a(i, j - 1, k) == mod_ecru_MapleTree.blockPlanter && world.func_72805_g(i, j - 1, k) != 0) || world.func_147439_a(i, j - 1, k) == mod_ecru_MapleTree.blockOreFlowerIron) {
            return true;
        }
        return false;
    }
    ...
    public void func_149690_a(World world, int i, int j, int k, int l, float m, int n) {
        ...
        switch (meta) {
            ...
            default:
                return;
            case 1:
                dp = this.random.nextInt(1) + this.blockInfo.dropOreNum[1][1];
                break;
            case 2:
                dp = this.random.nextInt(1) + this.blockInfo.dropOreNum[1][2];
                break;
            case 3:
                dp = this.random.nextInt(1) + this.blockInfo.dropOreNum[1][3];
                break;
            case 4:
                dp = this.random.nextInt(1) + this.blockInfo.dropOreNum[1][4];
                break;
            case 5:
                dp = this.random.nextInt(1) + this.blockInfo.dropOreNum[1][5];
                break;
            case 6:
                dp = this.random.nextInt(1) + this.blockInfo.dropOreNum[1][6];
                break;
            case 7:
                dp = this.random.nextInt(1) + this.blockInfo.dropOreNum[1][7];
                break;
        }
        ecru_IdList ecru_idlist = this.blockInfo;
        func_149642_a(world, i, j, k, new ItemStack(ecru_IdList.dropItemId[1], dp, 0));
    }
    ...
    public void func_149651_a(IIconRegister par1IconRegister) {
        ...
        for (int i2 = 0; i2 < 8; i2++) {
            tx_flower[i2] = par1IconRegister.func_94245_a("mapletree:iron_flower_" + i2);
        }
    }
