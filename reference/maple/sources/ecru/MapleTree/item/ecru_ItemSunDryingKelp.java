...
public class ecru_ItemSunDryingKelp extends Item {
    private String itemName;
    private final int COUNT = 2400;

    public ecru_ItemSunDryingKelp(String str) {
        func_77627_a(true);
        func_77656_e(0);
    ...
    public boolean func_77648_a(ItemStack itemstack, EntityPlayer entityplayer, World world, int i, int j, int k, int l, float par8, float par9, float par10) {
        if (!world.field_72995_K) {
            ...
            if (tile != null) {
                ...
                tile.setItemIn(new ItemStack(mod_ecru_MapleTree.Item_foodstuff, 1, 22));
                tile.setItemOut(new ItemStack(mod_ecru_MapleTree.Item_foodstuff, 9, 23));
