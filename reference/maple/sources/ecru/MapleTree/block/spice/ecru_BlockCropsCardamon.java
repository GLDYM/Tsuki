...
public class ecru_BlockCropsCardamon extends ecru_BlockCropsBase {

    @SideOnly(Side.CLIENT)
    private IIcon[] iconArray;
    private int[] GrowthProbability = {3, 3, 3, 3, 3, 11, 18, 0};
    ...
    public ecru_BlockCropsCardamon() {
        func_149675_a(true);
    ...
    protected Item func_149866_i() {
        return mod_ecru_MapleTree.Item_cardamonFruit;
    }
