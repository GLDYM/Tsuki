...
public class ecru_EntityBubbleFX extends EntityFX {
    ...
    public ecru_EntityBubbleFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12) {
