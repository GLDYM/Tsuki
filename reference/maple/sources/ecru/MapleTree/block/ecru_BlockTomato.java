...
public class ecru_BlockTomato extends BlockCrops {
    public static IIcon[] tx_vine;
    public static IIcon tx_tomato;
    private Random random = new Random();

    public ecru_BlockTomato() {
        func_149675_a(true);
    }
    ...
    protected Item func_149866_i() {
        return mod_ecru_MapleTree.Item_tomatoSeeds;
    }

    protected Item func_149865_P() {
        return mod_ecru_MapleTree.Item_tomato;
    }
    ...
    public IIcon getTomatoIcon(int i) {
        return tx_tomato;
    }

    public int getTomatoNum(int i) {
        int num = 0;
        if (i >= 5 && i <= 7) {
            num = i - 5;
        }
    ...
    public void func_149651_a(IIconRegister par1IconRegister) {
        tx_vine = new IIcon[8];
        tx_vine[0] = par1IconRegister.func_94245_a("mapletree:tomatoLeaf_0");
        tx_vine[1] = par1IconRegister.func_94245_a("mapletree:tomatoLeaf_1");
        tx_vine[2] = par1IconRegister.func_94245_a("mapletree:tomatoLeaf_2");
        tx_vine[3] = par1IconRegister.func_94245_a("mapletree:tomatoLeaf_3");
        tx_vine[4] = par1IconRegister.func_94245_a("mapletree:tomatoLeaf_3");
        tx_vine[5] = par1IconRegister.func_94245_a("mapletree:tomatoLeaf_3");
        tx_vine[6] = par1IconRegister.func_94245_a("mapletree:tomatoLeaf_3");
        tx_vine[7] = par1IconRegister.func_94245_a("mapletree:tomatoLeaf_3");
        tx_tomato = par1IconRegister.func_94245_a("mapletree:tomatoBlock");
    }
}
