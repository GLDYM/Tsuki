...
public class ecru_BlockCinnamonLeaves extends ecru_BlockSpiceLeavesBase {
    ...
    public ecru_BlockCinnamonLeaves() {
        super(Material.field_151584_j, false);
        this.random = new Random();
        this.tx_leaves = new IIcon[8];
        this.GrowthProbability = new int[]{10, 10, 10, 10};
    ...
    public boolean func_149727_a(World world, int i, int j, int k, EntityPlayer entityplayer, int l, float m, float n, float o) {
        ...
        if ((meta & 3) == 3) {
            dropBlockAsItemSpace(world, i, j, k, new ItemStack(mod_ecru_MapleTree.Item_cinnamonFruit, 1, 0));
    ...
    public void func_149690_a(World world, int i, int j, int k, int l, float m, int n) {
        ...
        if ((l & 3) == 3) {
            func_149642_a(world, i, j, k, new ItemStack(mod_ecru_MapleTree.Item_cinnamonFruit, 1, 0));
        }
    }
    ...
    public void func_149651_a(IIconRegister par1IconRegister) {
        this.tx_leaves[0] = par1IconRegister.func_94245_a("mapletree:cinnamonLeaves_0");
        this.tx_leaves[1] = par1IconRegister.func_94245_a("mapletree:cinnamonLeavesFast_0");
        this.tx_leaves[2] = par1IconRegister.func_94245_a("mapletree:cinnamonLeaves_1");
        this.tx_leaves[3] = par1IconRegister.func_94245_a("mapletree:cinnamonLeavesFast_1");
        this.tx_leaves[4] = par1IconRegister.func_94245_a("mapletree:cinnamonLeaves_2");
        this.tx_leaves[5] = par1IconRegister.func_94245_a("mapletree:cinnamonLeavesFast_2");
        this.tx_leaves[6] = par1IconRegister.func_94245_a("mapletree:cinnamonLeaves_3");
        this.tx_leaves[7] = par1IconRegister.func_94245_a("mapletree:cinnamonLeavesFast_3");
    }
