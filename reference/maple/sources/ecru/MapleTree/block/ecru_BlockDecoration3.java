...
public class ecru_BlockDecoration3 extends Block {
    private int texID;
    public static IIcon tx_deco_other;
    public static IIcon tx_glass;
    public static IIcon tx_black;

    public ecru_BlockDecoration3(int j) {
    ...
    public void func_149651_a(IIconRegister par1IconRegister) {
        if (this.texID == 0) {
            tx_deco_other = par1IconRegister.func_94245_a("mapletree:deco_other");
        } else {
            tx_deco_other = par1IconRegister.func_94245_a(mod_ecru_MapleTree.texList3[this.texID]);
        }
