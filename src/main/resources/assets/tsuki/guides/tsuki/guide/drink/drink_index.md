...
Base wine are the primary component for making cocktails. They can be created using [fermenters and distillers](fermenter.md) or purchased from the [Japanese Farmer](../villager/villager_index.md).

See the [fermenter/distiller](fermenter.md) page for usage instructions. You can use bottles directly for drinking, but the effect duration will be reduced. Using glass cups extends effect duration and allows for further cocktail mixing.
...
- Cannon: Reduce the charging time needed for ranged attacks.
- Golden Life: Remove all debuffs every 2 ticks.
- Poison: Give attacked mobs Poison II for 15s.
- Scorpion: Give attacked mobs Poison IV for 45s.