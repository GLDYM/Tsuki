...
public class ecru_BlockCropsStickyRice extends BlockCrops {

    @SideOnly(Side.CLIENT)
    private IIcon[] iconArray;

    public ecru_BlockCropsStickyRice() {
        func_149675_a(true);
    ...
    public boolean func_149742_c(World world, int i, int j, int k) {
        ...
        Block b2 = world.func_147439_a(i, j - 2, k);
        int meta1 = world.func_72805_g(i, j - 1, k);
        if ((blockLiquidFunc_147439_a == Blocks.field_150355_j || blockLiquidFunc_147439_a == Blocks.field_150358_i) && meta1 == 0 && b2 == Blocks.field_150458_ak) {
            return true;
        }
        return false;
    }
    ...
    private float getGrowthRate(World p_149864_1_, int p_149864_2_, int p_149864_3_, int p_149864_4_) {
        ...
        for (int l = p_149864_2_ - 1; l <= p_149864_2_ + 1; l++) {
            for (int i1 = p_149864_4_ - 1; i1 <= p_149864_4_ + 1; i1++) {
                float f1 = 0.0f;
                if (p_149864_1_.func_147439_a(l, p_149864_3_ - 2, i1).canSustainPlant(p_149864_1_, l, p_149864_3_ - 2, i1, ForgeDirection.UP, this)) {
                    f1 = 1.0f;
                    if (p_149864_1_.func_147439_a(l, p_149864_3_ - 2, i1).isFertile(p_149864_1_, l, p_149864_3_ - 2, i1)) {
                        f1 = 3.0f;
                    }
                }
    ...
    protected Item func_149866_i() {
        return mod_ecru_MapleTree.Item_unhulledStickyRice;
    }
    ...
    public void func_149651_a(IIconRegister par1IconRegister) {
        ...
        for (int i = 0; i < this.iconArray.length; i++) {
            this.iconArray[i] = par1IconRegister.func_94245_a("mapletree:stickyRiceCrops_" + i);
        }
    }
