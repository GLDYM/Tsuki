...
public class ecru_PacketLighthouse implements IMessage {
    int x;
    int y;
    int z;
    int color;
    ...
    public ecru_PacketLighthouse(int _x, int _y, int _z, int _color, int _length, int _width, int _tra) {
        this.x = 0;
        this.y = 0;
        this.z = 0;
        this.color = 0;
    ...
    public static class Handler implements IMessageHandler<ecru_PacketLighthouse, IMessage> {
        @SideOnly(Side.CLIENT)
        public IMessage onMessage(ecru_PacketLighthouse message, MessageContext ctx) {
