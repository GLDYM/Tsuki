...
public class ecru_GuiLighthouseIllumination extends GuiContainer {
    ...
    private ecru_ContainerLighthouseIllumination container;
    private ecru_TileEntityLighthouseIllumination LiTileEntity;
    ...
    public ecru_GuiLighthouseIllumination(EntityPlayer player, ecru_TileEntityLighthouseIllumination tileEntity, World world, int x, int y, int z) {
        super(new ecru_ContainerLighthouseIllumination(player, tileEntity, world, x, y, z));
        ...
        this.container = (ecru_ContainerLighthouseIllumination) this.field_147002_h;
        this.rgb = tileEntity.LiColor;
    }
    ...
    public void func_73866_w_() {
        ...
        this.textfield2.func_146180_a(Integer.toString(this.LiTileEntity.LiTransparency));
    }
    ...
    protected void func_146979_b(int i, int j) {
        this.field_146289_q.func_78276_b("LighthouseIllumination", 8, 6, mod_ecru_MapleTree.guiFontColor);
        ...
        String tmp = "00000000" + Integer.toHexString(this.LiTileEntity.LiColor);
        int ln = tmp.length();
        this.field_146289_q.func_78276_b("" + tmp.substring(ln - 6), 12, 35, mod_ecru_MapleTree.guiFontColor);
        this.field_146289_q.func_78276_b("" + this.LiTileEntity.LiLength, 12, 67, mod_ecru_MapleTree.guiFontColor);
        this.field_146289_q.func_78276_b("" + this.LiTileEntity.LiWidth, 12, 99, mod_ecru_MapleTree.guiFontColor);
        this.field_146289_q.func_78276_b("" + this.LiTileEntity.LiTransparency, 12, 131, mod_ecru_MapleTree.guiFontColor);
    ...
    protected void func_146284_a(GuiButton par1GuiButton) throws NumberFormatException {
        ...
        int co = this.LiTileEntity.LiColor;
        int le = this.LiTileEntity.LiLength;
        int wi = this.LiTileEntity.LiWidth;
        int tr = this.LiTileEntity.LiTransparency;
        if (par1GuiButton.field_146127_k == 1 && le > 5) {
            le--;
            this.LiTileEntity.LiLength = le;
        }
        ...
        if (par1GuiButton.field_146127_k == 5) {
            ...
            this.LiTileEntity.LiTransparency = tr;
        }
        ecru_PacketHandler.network.sendToServer(new ecru_PacketLighthouseB(this.x1, this.y1, this.z1, co, le, wi, tr));
    }
