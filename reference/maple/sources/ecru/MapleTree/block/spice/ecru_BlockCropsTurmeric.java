...
public class ecru_BlockCropsTurmeric extends ecru_BlockCropsBase {

    @SideOnly(Side.CLIENT)
    private IIcon[] iconArray;
    private int[] GrowthProbability = {3, 3, 3, 3, 8, 18, 8, 0};
    ...
    public ecru_BlockCropsTurmeric() {
        func_149675_a(true);
    ...
    protected Item func_149866_i() {
        return mod_ecru_MapleTree.Item_turmericRoot;
    }
    ...
    public void func_149651_a(IIconRegister par1IconRegister) {
        ...
        for (int i = 0; i < this.iconArray.length; i++) {
            this.iconArray[i] = par1IconRegister.func_94245_a("mapletree:turmeric_" + i);
        }
    }
