...
public class ecru_BlockCloveLeaves extends ecru_BlockSpiceLeavesBase {
    ...
    public ecru_BlockCloveLeaves() {
        super(Material.field_151584_j, false);
        this.random = new Random();
        this.tx_leaves = new IIcon[8];
        this.GrowthProbability = new int[]{30, 60, 20, 0};
    ...
    public boolean func_149727_a(World world, int i, int j, int k, EntityPlayer entityplayer, int l, float m, float n, float o) {
        ...
        if ((meta & 3) == 3) {
            dropBlockAsItemSpace(world, i, j, k, new ItemStack(mod_ecru_MapleTree.Item_cloveFruit, 1, 0));
        ...
        if ((meta & 3) == 1) {
            dropBlockAsItemSpace(world, i, j, k, new ItemStack(mod_ecru_MapleTree.Item_cloveBud, 1, 0));
            world.func_72921_c(i, j, k, meta & 12, 3);
            world.func_72908_a(i, j, k, "random.pop", 0.2f, (((this.random.nextFloat() - this.random.nextFloat()) * 0.7f) + 1.0f) * 2.0f);
            return true;
        }
    ...
    public void func_149690_a(World world, int i, int j, int k, int l, float m, int n) {
        ...
        if ((l & 3) == 3) {
            func_149642_a(world, i, j, k, new ItemStack(mod_ecru_MapleTree.Item_cloveFruit, 1, 0));
        } else if ((l & 3) == 1) {
            func_149642_a(world, i, j, k, new ItemStack(mod_ecru_MapleTree.Item_cloveBud, 1, 0));
        }
    }
    ...
    public void func_149651_a(IIconRegister par1IconRegister) {
        this.tx_leaves[0] = par1IconRegister.func_94245_a("mapletree:cloveLeaves_0");
        this.tx_leaves[1] = par1IconRegister.func_94245_a("mapletree:cloveLeavesFast_0");
        this.tx_leaves[2] = par1IconRegister.func_94245_a("mapletree:cloveLeaves_1");
        this.tx_leaves[3] = par1IconRegister.func_94245_a("mapletree:cloveLeavesFast_1");
        this.tx_leaves[4] = par1IconRegister.func_94245_a("mapletree:cloveLeaves_2");
        this.tx_leaves[5] = par1IconRegister.func_94245_a("mapletree:cloveLeavesFast_2");
        this.tx_leaves[6] = par1IconRegister.func_94245_a("mapletree:cloveLeaves_3");
        this.tx_leaves[7] = par1IconRegister.func_94245_a("mapletree:cloveLeavesFast_3");
    }
