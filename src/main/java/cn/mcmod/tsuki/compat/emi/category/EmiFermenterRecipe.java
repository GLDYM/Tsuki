...
public class EmiFermenterRecipe extends BasicEmiRecipe {
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(
            ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "fermenting"),
            EmiStack.of(BlockRegistry.FERMENTER.get()));
    ...
    private EmiFermenterRecipe(ResourceLocation id, FermenterRecipe recipe, List<EmiIngredient> inputs,
    ...
    public static EmiFermenterRecipe of(ResourceLocation id, FermenterRecipe recipe) {
        ...
        return new EmiFermenterRecipe(id, recipe, inputList, outputList);
    }

    @Override
    public void addWidgets(WidgetHolder widgets) {
        widgets.addTexture(BG, 0, 0, WIDTH, HEIGHT, 32, 16);
        widgets.addAnimatedTexture(BG, 44, 28, 24, 17, 176, 0, 900, true, false, false);
        widgets.addAnimatedTexture(BG, 46, 10, 18, 18, 176, 35, 1400, false, true, false);
