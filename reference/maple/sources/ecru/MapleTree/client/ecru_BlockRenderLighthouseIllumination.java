...
public class ecru_BlockRenderLighthouseIllumination implements ISimpleBlockRenderingHandler {
    private static final ResourceLocation textures_LighthouseIllumination = new ResourceLocation("mapletree", "textures/model/LighthouseIllumination.png");
    ...
    public void renderInventoryBlock(Block block, int i, int modelID, RenderBlocks renderblocks) {
        GL11.glPushMatrix();
        Minecraft.func_71410_x().field_71446_o.func_110577_a(textures_LighthouseIllumination);
        GL11.glTranslatef(0.0f, 1.0f, 0.0f);
        GL11.glScalef(1.0f, 1.0f, 1.0f);
        GL11.glRotatef(180.0f, 0.0f, 0.0f, 1.0f);
        ecru_TileEntityLighthouseIlluminationRender.model.render2(0.0625f);
        GL11.glPopMatrix();
    }
