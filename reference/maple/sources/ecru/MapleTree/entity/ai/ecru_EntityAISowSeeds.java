...
public class ecru_EntityAISowSeeds extends EntityAIBase {
    ...
    public ecru_EntityAISowSeeds(ecru_EntityMomiji pEntity, float pmoveSpeed, int bit) {
    ...
    public void func_75249_e() {
        ...
        if (mod_ecru_MapleTree.plantSeedRandom) {
            List ssList = new ArrayList();
            for (int ss = 3; ss < 21; ss++) {
                if (this.entityMomiji.thisSeeds(ss)) {
                    ssList.add(Integer.valueOf(ss));
                }
            }
            int li = this.entityMomiji.func_70681_au().nextInt(ssList.size());
            int i = ((Integer) ssList.get(li)).intValue();
            if (this.entityMomiji.thisSeeds(i)) {
            ...
            for (int i2 = 3; i2 < 21; i2++) {
                if (this.entityMomiji.thisSeeds(i2)) {
                    ItemStack is2 = this.entityMomiji.itemStacks[i2];
                    if (is2.func_77973_b().func_77648_a(is2, fakePlayer, this.worldObject, (int) this.xPosition, (int) this.yPosition, (int) this.zPosition, 1, 0.0f, 0.0f, 0.0f)) {
                        this.entityMomiji.func_71038_i();
                        if (this.entityMomiji.func_70301_a(i2).field_77994_a == 0) {
                            this.entityMomiji.func_70298_a(i2, 1);
                        }
                        return;
                    }
                }
