...
public class ecru_BlockRenderTomato implements ISimpleBlockRenderingHandler {
    ...
    public int getRenderId() {
        return mod_ecru_MapleTree.renderTomatoID;
    }
    ...
    private void render(IBlockAccess iblockaccess, int blockX, int blockY, int blockZ, Block block, int renderType, RenderBlocks renderblocks) {
        ...
        if (meta >= 5 && meta <= 7) {
            drawTomato((ecru_BlockTomato) block, meta, d0, d1, d2, 1.0f, iblockaccess, renderblocks);
        }
    }

    public void drawTomato(ecru_BlockTomato par1Block, int meta, double i, double j, double k, float par9, IBlockAccess iblockaccess, RenderBlocks renderblocks) {
        ...
        IIcon icon = par1Block.getTomatoIcon(meta);
        int num = par1Block.getTomatoNum(meta);
        ...
        switch (num) {
            case 0:
                if (tmpxz < 0 || tmpxz >= 2) {
                    ...
                    double yMin = j + this.P26;
                    double yMax = j + this.P30;
                ...
                if (tmpxz <= 1 || tmpxz >= 4) {
                    ...
                    double yMin2 = j + this.P23;
                    double yMax2 = j + this.P27;
                ...
                if (tmpxz <= 3 || tmpxz >= 6) {
                    ...
                    double yMin3 = j + this.P12;
                    double yMax3 = j + this.P16;
                ...
                if (tmpxz <= 5 || tmpxz >= 8) {
                    ...
                    double yMin4 = j + this.P09;
                    double yMax4 = j + this.P13;
                ...
                if (tmpxz <= 7 || tmpxz > 9) {
                    double xMin5 = i + this.P12;
                    double xMax5 = i + this.P16;
                    double yMin5 = j + this.P25;
                    double yMax5 = j + this.P29;
                    double zMin5 = k + this.P05;
                    double zMax5 = k + this.P09;
                ...
                if (tmpxz <= 1 || tmpxz >= 6) {
                    double xMin6 = i + this.P17;
                    double xMax6 = i + this.P21;
                    double yMin6 = j + this.P09;
                    double yMax6 = j + this.P13;
                    double zMin6 = k + this.P20;
                    double zMax6 = k + this.P24;
            ...
            case 1:
                if (tmpxz <= 0 || tmpxz >= 2) {
                    double xMin7 = i + this.P03;
                    double xMax7 = i + this.P11;
                    double yMin7 = j + this.P22;
                    double yMax7 = j + this.P30;
                    double zMin7 = k + this.P21;
                    double zMax7 = k + this.P29;
                ...
                if (tmpxz <= 1 || tmpxz >= 4) {
                    double xMin8 = i + this.P21;
                    double xMax8 = i + this.P29;
                    double yMin8 = j + this.P19;
                    double yMax8 = j + this.P27;
                    double zMin8 = k + this.P20;
                    double zMax8 = k + this.P28;
                ...
                if (tmpxz <= 3 || tmpxz >= 6) {
                    double xMin9 = i + this.P05;
                    double xMax9 = i + this.P13;
                    double yMin9 = j + this.P08;
                    double yMax9 = j + this.P16;
                    double zMin9 = k + this.P05;
                    double zMax9 = k + this.P13;
                ...
                if (tmpxz <= 5 || tmpxz >= 8) {
                    double xMin10 = i + this.P19;
                    double xMax10 = i + this.P27;
                    double yMin10 = j + this.P05;
                    double yMax10 = j + this.P13;
                    double zMin10 = k + this.P03;
                    double zMax10 = k + this.P11;
                ...
                if (tmpxz <= 7 || tmpxz > 9) {
                    double xMin11 = i + this.P10;
                    double xMax11 = i + this.P18;
                    double yMin11 = j + this.P21;
                    double yMax11 = j + this.P29;
                    double zMin11 = k + this.P03;
                    double zMax11 = k + this.P11;
                ...
                if (tmpxz <= 1 || tmpxz >= 6) {
                    double xMin12 = i + this.P15;
                    double xMax12 = i + this.P23;
                    double yMin12 = j + this.P05;
                    double yMax12 = j + this.P13;
                    double zMin12 = k + this.P18;
                    double zMax12 = k + this.P26;
            ...
            case 2:
                if (tmpxz <= 0 || tmpxz >= 2) {
                    double xMin13 = i + this.P02;
                    double xMax13 = i + this.P12;
                    double yMin13 = j + this.P19;
                    double yMax13 = j + this.P30;
                    double zMin13 = k + this.P20;
                    double zMax13 = k + this.P30;
                    drawTop(tess, xMin13, xMax13, yMin13, yMax13, zMin13, zMax13, uMinT, uMaxT, vMinT, vMaxT);
                    drawBottom(tess, xMin13, xMax13, yMin13, yMax13, zMin13, zMax13, uMinB, uMaxB, vMinB, vMaxB);
                    drawSide(tess, xMin13, xMax13, yMin13, yMax13, zMin13, zMax13, uMin, uMax, vMin, vMax);
                }
                if (tmpxz <= 1 || tmpxz >= 4) {
                    double xMin14 = i + this.P20;
                    double xMax14 = i + this.P30;
                    double yMin14 = j + this.P16;
                    double yMax14 = j + this.P27;
                    double zMin14 = k + this.P19;
                    double zMax14 = k + this.P29;
                    drawTop(tess, xMin14, xMax14, yMin14, yMax14, zMin14, zMax14, uMinT, uMaxT, vMinT, vMaxT);
                    drawBottom(tess, xMin14, xMax14, yMin14, yMax14, zMin14, zMax14, uMinB, uMaxB, vMinB, vMaxB);
                    drawSide(tess, xMin14, xMax14, yMin14, yMax14, zMin14, zMax14, uMin, uMax, vMin, vMax);
                }
                if (tmpxz <= 3 || tmpxz >= 6) {
                    double xMin15 = i + this.P04;
                    double xMax15 = i + this.P14;
                    double yMin15 = j + this.P05;
                    double yMax15 = j + this.P16;
                    double zMin15 = k + this.P04;
                    double zMax15 = k + this.P14;
                    drawTop(tess, xMin15, xMax15, yMin15, yMax15, zMin15, zMax15, uMinT, uMaxT, vMinT, vMaxT);
                    drawBottom(tess, xMin15, xMax15, yMin15, yMax15, zMin15, zMax15, uMinB, uMaxB, vMinB, vMaxB);
                    drawSide(tess, xMin15, xMax15, yMin15, yMax15, zMin15, zMax15, uMin, uMax, vMin, vMax);
                }
                if (tmpxz <= 5 || tmpxz >= 8) {
                    double xMin16 = i + this.P18;
                    double xMax16 = i + this.P28;
                    double yMin16 = j + this.P02;
                    double yMax16 = j + this.P13;
                    double zMin16 = k + this.P02;
                    double zMax16 = k + this.P12;
                    drawTop(tess, xMin16, xMax16, yMin16, yMax16, zMin16, zMax16, uMinT, uMaxT, vMinT, vMaxT);
                    drawBottom(tess, xMin16, xMax16, yMin16, yMax16, zMin16, zMax16, uMinB, uMaxB, vMinB, vMaxB);
                    drawSide(tess, xMin16, xMax16, yMin16, yMax16, zMin16, zMax16, uMin, uMax, vMin, vMax);
                }
                if (tmpxz <= 7 || tmpxz > 9) {
                    double xMin17 = i + this.P09;
                    double xMax17 = i + this.P19;
                    double yMin17 = j + this.P18;
                    double yMax17 = j + this.P29;
                    double zMin17 = k + this.P02;
                    double zMax17 = k + this.P12;
                    drawTop(tess, xMin17, xMax17, yMin17, yMax17, zMin17, zMax17, uMinT, uMaxT, vMinT, vMaxT);
                    drawBottom(tess, xMin17, xMax17, yMin17, yMax17, zMin17, zMax17, uMinB, uMaxB, vMinB, vMaxB);
                    drawSide(tess, xMin17, xMax17, yMin17, yMax17, zMin17, zMax17, uMin, uMax, vMin, vMax);
                }
                if (tmpxz <= 1 || tmpxz >= 6) {
                    double xMin18 = i + this.P14;
                    double xMax18 = i + this.P24;
                    double yMin18 = j + this.P02;
                    double yMax18 = j + this.P13;
                    double zMin18 = k + this.P17;
                    double zMax18 = k + this.P27;
                    drawTop(tess, xMin18, xMax18, yMin18, yMax18, zMin18, zMax18, uMinT, uMaxT, vMinT, vMaxT);
                    drawBottom(tess, xMin18, xMax18, yMin18, yMax18, zMin18, zMax18, uMinB, uMaxB, vMinB, vMaxB);
                    drawSide(tess, xMin18, xMax18, yMin18, yMax18, zMin18, zMax18, uMin, uMax, vMin, vMax);
                    break;
                }
                break;
        }
