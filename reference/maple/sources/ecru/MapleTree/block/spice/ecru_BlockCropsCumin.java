...
public class ecru_BlockCropsCumin extends ecru_BlockCropsBase {

    @SideOnly(Side.CLIENT)
    private IIcon[] iconArray;
    private int[] GrowthProbability = {3, 3, 3, 3, 12, 22, 8, 0};
    private String[] affinityLv1 = {"Plains", "Forest", "Jungle", "JungleHills", "JungleEdge", "Roofed Forest", "Birch Forest", "Birch Forest Hills"};
    ...
    protected Item func_149866_i() {
        return mod_ecru_MapleTree.Item_cuminSeed;
    }
    ...
    public void func_149651_a(IIconRegister par1IconRegister) {
        ...
        for (int i = 0; i < this.iconArray.length; i++) {
            this.iconArray[i] = par1IconRegister.func_94245_a("mapletree:cumin_" + i);
        }
    }
