...
public class TsukiBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(BlockTags.PLANKS)
                .add(new Block[] { (Block) BlockRegistry.SAKURA_PLANK.get(), (Block) BlockRegistry.BAMBOO_PLANK.get(),
                        (Block) BlockRegistry.MAPLE_PLANK.get() });
        this.tag(BlockTags.FENCES)
                .add(new Block[] { (Block) BlockRegistry.BAMBOO_FENCE.get(),
                        (Block) BlockRegistry.BAMBOO_FENCE_SUNBURNT.get() });
