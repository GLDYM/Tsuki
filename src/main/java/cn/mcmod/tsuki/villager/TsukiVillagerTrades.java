...
public final class TsukiVillagerTrades {
    ...
    private static void registerWaFarmerTrades(Int2ObjectMap<List<VillagerTrades.ItemListing>> trades) {
        ...
        trades.get(2).add(sellForCoins(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.HOP).get(), 8, 3, 5, 12, 10));
        ...
        trades.get(3).add(buyWithCoins(FoodRegistry.FOODSET.get(TsukiFoodSet.MATSUTAKE).get(), 4, 16, 32, 12, 15));
        trades.get(3).add(sellForCoins(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.SALT).get(), 8, 2, 7, 12, 15));
        trades.get(3).add(sellForCoins(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.SOYSAUCE).get(), 8, 3, 6, 12, 15));
        trades.get(3).add(sellForCoins(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.MISO).get(), 8, 3, 7, 12, 15));
        trades.get(3).add(sellForCoins(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.DASHI).get(), 8, 3, 5, 12, 15));
        trades.get(3).add(sellForCoins(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.KOUJI).get(), 8, 2, 5, 12, 15));
        trades.get(3).add(sellForCoins(FoodRegistry.FOODSET.get(TsukiFoodSet.TOFU).get(), 8, 4, 7, 12, 15));
        trades.get(3).add(sellForCoins(FoodRegistry.FOODSET.get(TsukiFoodSet.NATTO).get(), 8, 3, 5, 12, 15));
