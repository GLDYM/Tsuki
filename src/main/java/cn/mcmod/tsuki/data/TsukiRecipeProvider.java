...
public class TsukiRecipeProvider extends AbstractRecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput consumer) {
        ...
        SpecialRecipeBuilder.special(cn.mcmod.tsuki.recipe.CookingPotServingRecipe::new)
                .save(consumer, Tsuki.MODID + ":cooking_pot_serving");
    }
    ...
    private void registerCraftingRecipe(RecipeOutput consumer) {
        ...
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, ItemRegistry.MATERIALS.get(TsukiNormalItemSet.BLACK_TEA_LEAVES).get())
                .requires(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.GREEN_TEA_LEAVES).get())
                .unlockedBy("has_green_tea_leaves",
                        has(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.GREEN_TEA_LEAVES).get()))
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "black_tea_leaves"));
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, ItemRegistry.MATERIALS.get(TsukiNormalItemSet.EARL_GREY_LEAVES).get())
                ...
                .unlockedBy("has_black_tea_leaves",
                        has(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.BLACK_TEA_LEAVES).get()))
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "earl_grey_leaves"));
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, ItemRegistry.MATERIALS.get(TsukiNormalItemSet.FRUIT_TEA_LEAVES).get())
                .requires(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.BLACK_TEA_LEAVES).get())
        ...
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, ItemRegistry.MATERIALS.get(TsukiNormalItemSet.MINT_TEA_LEAVES).get())
                .requires(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.GREEN_TEA_LEAVES).get())
        ...
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, ItemRegistry.MATERIALS.get(TsukiNormalItemSet.RICE_TEA_LEAVES).get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, BlockItemRegistry.MAPLE_CAULDRON.get())
                .pattern("ILI")
                .pattern("ILI")
                .pattern("I I")
                .define('I', Tags.Items.INGOTS_IRON)
                .define('L', TsukiItemTags.LUMBER)
                .unlockedBy("has_item", has(TsukiItemTags.LUMBER))
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "maple_cauldron"));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, BlockItemRegistry.MAPLE_SPILE.get())
                .pattern("LLL")
                .pattern("III")
                .pattern("I  ")
                .define('I', Tags.Items.INGOTS_IRON)
                .define('L', TsukiItemTags.LUMBER)
                .unlockedBy("has_item", has(TsukiItemTags.LUMBER))
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "maple_spile"));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, BlockItemRegistry.MAPLE_SPILE.get())
                .pattern("LLL")
                .pattern("III")
                .pattern("  I")
                ...
                .define('L', TsukiItemTags.LUMBER)
                .unlockedBy("has_item", has(TsukiItemTags.LUMBER))
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "maple_spile_mirror"));
        ...
        // .requires(TsukiArmorToolRegistry.SHEATH.get())
        // .unlockedBy("has_sakura_katana",
        // has(TsukiArmorToolRegistry.SAKURA_KATANA.get()))
        // .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID,
        // "sakura_katana_sheath"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
                ...
                .requires(ArmorToolRegistry.KIMONO_ENE.get())
                .requires(ArmorToolRegistry.SAKURA_DIAMOND.get())
                .unlockedBy("has_item", has(ArmorToolRegistry.SAKURA_DIAMOND.get()))
                .save(consumer);
        ...
        this.foodSmeltingRecipes(
                ...
                consumer);
        this.foodSmeltingRecipes(
                "taro_bake", ItemRegistry.TARO.get(), FoodRegistry.FOODSET.get(TsukiFoodSet.TARO_BAKED).get(), 0.5F,
                consumer);
        this.foodSmeltingRecipes(
                "chestnut_toasted",
                ...
                consumer);
        this.foodSmeltingRecipes(
                "matsutake_to_roast_matsutake",
                FoodRegistry.FOODSET.get(TsukiFoodSet.MATSUTAKE).get(),
                FoodRegistry.FOODSET.get(TsukiFoodSet.ROAST_MATSUTAKE).get(),
                0.35F,
                consumer);
        ...
        this.makeItemToBucket(BucketItemRegistry.FOOD_OIL_BUCKET, Ingredient.of(ItemRegistry.SUNFLOWER_SEEDS.get()))
                ...
                .save(consumer,
                        ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "food_oil_bucket_from_sunflower_seeds"));
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.DECORATIONS, ItemRegistry.MATERIALS.get(TsukiNormalItemSet.DOUGH).get(), 3)
        ...
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.DECORATIONS,
                        ItemRegistry.MATERIALS.get(TsukiNormalItemSet.DOUGH_BUCKWHEAT).get(), 3)
                ...
                .save(consumer);
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.DECORATIONS, ItemRegistry.MATERIALS.get(TsukiNormalItemSet.DOUGH_RICE).get(),
                        3)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, BlockRegistry.TEISHOKU_BURGER.get())
                ...
                .save(consumer);
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.DECORATIONS, FoodRegistry.FOODSET.get(TsukiFoodSet.SASHIMI).get())
                ...
                .save(consumer);
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.DECORATIONS, FoodRegistry.FOODSET.get(TsukiFoodSet.CHIKUWA_RAW).get(), 2)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.ONIGIRI).get())
                ...
                .save(consumer);
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.ONIGIRI_BAMBOO).get())
                .requires(FoodRegistry.CUISINES.get(TsukiCuisineSet.RICE_COOKED).get())
                .requires(Items.DRIED_KELP)
                ...
                .save(consumer);
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.ONIGIRI_SEAWEED).get())
                .requires(FoodRegistry.CUISINES.get(TsukiCuisineSet.RICE_COOKED).get())
                .requires(Items.DRIED_KELP)
                .requires(Items.DRIED_KELP)
                .unlockedBy("has_rice", has(FoodRegistry.CUISINES.get(TsukiCuisineSet.RICE_COOKED).get()))
                .save(consumer);
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.ONIGIRI_MUSHROOM).get())
                .requires(FoodRegistry.CUISINES.get(TsukiCuisineSet.RICE_COOKED).get())
                .requires(Items.DRIED_KELP)
                .requires(TsukiItemTags.MUSHROOMS)
                .unlockedBy("has_rice", has(FoodRegistry.CUISINES.get(TsukiCuisineSet.RICE_COOKED).get()))
                .save(consumer);
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.ONIGIRI_TEMPURA).get())
                .requires(FoodRegistry.CUISINES.get(TsukiCuisineSet.RICE_COOKED).get())
                .requires(Items.DRIED_KELP)
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.TEMPURA).get())
                .unlockedBy("has_rice", has(FoodRegistry.CUISINES.get(TsukiCuisineSet.RICE_COOKED).get()))
                .save(consumer);
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.ONIGIRI_FISH).get(), 2)
                .requires(FoodRegistry.CUISINES.get(TsukiCuisineSet.RICE_COOKED).get())
                .requires(Items.DRIED_KELP)
                .requires(TsukiItemTags.SLICES_RAW_FISHES)
                .unlockedBy("has_rice", has(FoodRegistry.CUISINES.get(TsukiCuisineSet.RICE_COOKED).get()))
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "onigiri_fish"));
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.ONIGIRI_MATSUTAKE).get(), 2)
                .requires(FoodRegistry.CUISINES.get(TsukiCuisineSet.RICE_COOKED).get())
                .requires(Items.DRIED_KELP)
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.MATSUTAKE).get())
                .unlockedBy("has_rice", has(FoodRegistry.CUISINES.get(TsukiCuisineSet.RICE_COOKED).get()))
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "onigiri_matsutake"));
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.CUISINES.get(TsukiCuisineSet.EHOUMAKI).get(), 3)
                .requires(FoodRegistry.CUISINES.get(TsukiCuisineSet.RICE_COOKED).get())
                .requires(Items.DRIED_KELP)
                .requires(TsukiItemTags.VEGETABLES)
                .requires(TsukiItemTags.FOODS_COOKED_MEAT)
                .unlockedBy("has_rice", has(FoodRegistry.CUISINES.get(TsukiCuisineSet.RICE_COOKED).get()))
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "ehoumaki"));
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.BUGGYS_MEAT).get(), 4)
                ...
                .unlockedBy("has_raw_meat", has(TsukiItemTags.RAW_PORK))
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "buggys_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.SUSHI).get(), 2)
                ...
                .save(consumer);
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.SUSHI_SHRIMP).get(), 2)
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.VINEGAR_RICE).get())
                .requires(TsukiItemTags.SHRIMP)
                .unlockedBy("has_rice", has(FoodRegistry.FOODSET.get(TsukiFoodSet.VINEGAR_RICE).get()))
                .save(consumer);
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.SUSHI_TAMAGO).get(), 3)
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.VINEGAR_RICE).get())
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.TAMAGOYAKI).get())
                .unlockedBy("has_rice", has(FoodRegistry.FOODSET.get(TsukiFoodSet.VINEGAR_RICE).get()))
                .save(consumer);
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.SUSHI_INARI).get(), 2)
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.VINEGAR_RICE).get())
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.TOFU_FRIED).get())
                .unlockedBy("has_rice", has(FoodRegistry.FOODSET.get(TsukiFoodSet.VINEGAR_RICE).get()))
                .save(consumer);
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, ItemRegistry.MATERIALS.get(TsukiNormalItemSet.TEMPURA_BATTER).get(), 8)
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.HAMBURGER).get())
                ...
                .save(consumer);
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.BURGER_RAW).get(), 4)
        ...
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.CROQUETTE_DISH).get())
        ...
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.CHEESE_BURGER).get())
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.BUN).get())
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.BURGER).get())
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.MOCHI_SAKURA).get())
                ...
                .save(consumer);
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.MAPLE_COOKIE).get(), 4)
                .requires(TsukiItemTags.FLOUR)
                .requires(TsukiItemTags.SUGAR)
                .requires(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.MAPLE_SYRUP).get())
                .unlockedBy("has_maple_syrup", has(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.MAPLE_SYRUP).get()))
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "maple_cookie"));
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.POUND_CAKE).get(), 2)
                .requires(TsukiItemTags.FLOUR)
                .requires(TsukiItemTags.EGGS)
                .requires(TsukiItemTags.MILK)
                .requires(TsukiItemTags.SUGAR)
                .unlockedBy("has_flour", has(TsukiItemTags.FLOUR))
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "pound_cake"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.DORAYAKI).get(), 2)
                .requires(TsukiItemTags.FLOUR)
                .requires(TsukiItemTags.EGGS)
                .requires(TsukiItemTags.SUGAR)
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.REDBEAN_PASTE).get())
                .unlockedBy("has_redbean_paste", has(FoodRegistry.FOODSET.get(TsukiFoodSet.REDBEAN_PASTE).get()))
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "dorayaki"));
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.TAIYAKI_MOCHA).get())
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.TAIYAKI).get())
                .requires(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.MOCHA).get())
                .unlockedBy("has_taiyaki", has(FoodRegistry.FOODSET.get(TsukiFoodSet.TAIYAKI).get()))
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "taiyaki_mocha"));
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.MOCHA_COOKIE).get(), 4)
                .requires(TsukiItemTags.FLOUR)
                .requires(TsukiItemTags.SUGAR)
                .requires(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.MOCHA).get())
                .unlockedBy("has_mocha", has(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.MOCHA).get()))
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "mocha_cookie"));
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.FOODSET.get(TsukiFoodSet.POUND_CAKE_MOCHA).get(), 2)
                .requires(TsukiItemTags.FLOUR)
                .requires(TsukiItemTags.EGGS)
                .requires(TsukiItemTags.MILK)
                .requires(TsukiItemTags.SUGAR)
                .requires(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.MOCHA).get())
                .unlockedBy("has_mocha", has(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.MOCHA).get()))
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "pound_cake_mocha"));
        ...
        // .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID,
        // "bamboo_block_from_vanilla_bamboo"));
        this.makeIngotToBlock(BlockItemRegistry.BAMBOO_BLOCK_SUNBURNT,
                ItemRegistry.MATERIALS.get(TsukiNormalItemSet.BAMBOO_SUNBURNT))
                .unlockedBy("has_item", has(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.BAMBOO_SUNBURNT).get()))
                .save(consumer);
        this.makeIngotToBlock(BlockItemRegistry.BAMBOO_CHARCOAL_BLOCK,
                ItemRegistry.MATERIALS.get(TsukiNormalItemSet.BAMBOO_CHARCOAL))
                .unlockedBy("has_item", has(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.BAMBOO_CHARCOAL).get()))
                .save(consumer);
        this.makeBlockToIngot(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.BAMBOO), BlockItemRegistry.BAMBOO_BLOCK)
                .save(consumer);
        ...
        this.makeBlockToIngot(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.BAMBOO_CHARCOAL),
                BlockItemRegistry.BAMBOO_CHARCOAL_BLOCK)
                .save(consumer);
        this.makeBlockToIngot(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.BAMBOO_SUNBURNT),
        ...
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.CUISINES.get(TsukiCuisineSet.BENTO_STANDARD).get())
        ...
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.CUISINES.get(TsukiCuisineSet.BENTO_DELUXE).get())
                .requires(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.BENTO_BOX).get())
                .requires(FoodRegistry.CUISINES.get(TsukiCuisineSet.RICE_COOKED).get())
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.TEMPURA).get())
                .requires(TsukiItemTags.VEGETABLES)
        ...
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.CUISINES.get(TsukiCuisineSet.BENTO_PREMIUM).get())
                .requires(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.BENTO_BOX).get())
        ...
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.FOOD, FoodRegistry.CUISINES.get(TsukiCuisineSet.BENTO_SUPREME).get())
                .requires(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.BENTO_BOX).get())
                .requires(FoodRegistry.CUISINES.get(TsukiCuisineSet.RICE_COOKED).get())
        ...
        this.makeLumber(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.LUMBER_BAMBOO),
                Ingredient.of(TsukiItemTags.BAMBOO))
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .unlockedBy("has_item", has(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.BAMBOO_SUNBURNT).get()))
                .save(consumer,
                        ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "bamboo_charcoal_sunburnt_from_smelt"));
        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(BlockRegistry.IRON_SAND.get()), RecipeCategory.MISC, Items.IRON_INGOT, 0.7F,
                        200)
                .group(Tsuki.MODID)
        ...
        SimpleCookingRecipeBuilder
                .blasting(Ingredient.of(BlockRegistry.IRON_SAND.get()), RecipeCategory.MISC, Items.IRON_INGOT, 0.7F,
                        100)
                .group(Tsuki.MODID)
                .unlockedBy("has_iron_sand", has(BlockRegistry.IRON_SAND.get()))
                .save(consumer,
                        ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "iron_ingot_from_iron_sand_blasting"));
        // Actuallly Zuku cannot be gotten, because Iron Farm is very easy to build
        // after Minecraft 1.14
        // Those rubbish is only useful for modpack creators. LOL
        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(ArmorToolRegistry.ZUKU.get()), RecipeCategory.MISC,
                        ArmorToolRegistry.ZUKU_INGOT.get(), 0.5F, 200)
                .group(Tsuki.MODID)
        ...
        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(ArmorToolRegistry.ZUKU_INGOT.get()), RecipeCategory.MISC,
                        ArmorToolRegistry.SAGEGANE.get(), 0.7F, 200)
                .group(Tsuki.MODID)
        ...
        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(ArmorToolRegistry.SAGEGANE.get()), RecipeCategory.MISC, Items.IRON_INGOT, 0.7F,
                        200)
                .group(Tsuki.MODID)
                .unlockedBy("has_sagegane", has(ArmorToolRegistry.SAGEGANE.get()))
                .save(consumer,
                        ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "sagegane_to_iron_ingot_from_smelting"));
        // End Annotation
        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(ArmorToolRegistry.TAMAHAGANE.get()), RecipeCategory.MISC,
                        ArmorToolRegistry.STEEL_INGOT.get(), 0.7F, 200)
                .group(Tsuki.MODID)
                .unlockedBy("has_tamahagane", has(ArmorToolRegistry.TAMAHAGANE.get()))
    ...
    private void registerDecorativeBlockRecipes(RecipeOutput consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, BlockRegistry.BAMBOO_FENCE_SUNBURNT.get(), 3)
                ...
                .define('I', Tags.Items.RODS_WOODEN)
                .unlockedBy("has_bamboo_sunburnt",
                        has(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.BAMBOO_SUNBURNT).get()))
    ...
    private void registerMortarRecipe(RecipeOutput consumer) {
        ...
        StoneMortarRecipeBuilder.mortar(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.CHARCOAL_POWDER).get(), 1)
                .requires(Ingredient.of(Items.CHARCOAL,
                        ItemRegistry.MATERIALS.get(TsukiNormalItemSet.BAMBOO_CHARCOAL).get()), 2)
    ...
    private void registerCookingRecipe(RecipeOutput consumer) {
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.EMPTY, FoodRegistry.CUISINES.get(TsukiCuisineSet.BEEF_STICK).get(), 2)
                .requires(TsukiItemTags.RAW_BEEF)
                .requires(TsukiItemTags.BAMBOO)
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "beef_stick_cooking"));
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.EMPTY, FoodRegistry.CUISINES.get(TsukiCuisineSet.CHICKEN_STICK).get(), 2)
                .requires(TsukiItemTags.RAW_CHICKEN)
                .requires(TsukiItemTags.BAMBOO)
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "chicken_stick_cooking"));
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.EMPTY, FoodRegistry.CUISINES.get(TsukiCuisineSet.PORK_STICK).get(), 2)
                .requires(TsukiItemTags.RAW_PORK)
                .requires(TsukiItemTags.BAMBOO)
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "pork_stick_cooking"));
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.FOODSET.get(TsukiFoodSet.TOFU).get(), 2)
                .requires(TsukiItemTags.CROPS_SOYBEAN)
                .requires(TsukiItemTags.SALT)
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "tofu_cooking"));
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.FOODSET.get(TsukiFoodSet.MAYONAISE).get(), 2)
                .requires(TsukiItemTags.EGGS)
                .requires(TsukiItemTags.EGGS)
                .requires(TsukiItemTags.VINEGAR)
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "mayo_cooking"));
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiNormalItemSet.CURRY_SAUCE.getItem().get(), 2)
                .requires(TsukiNormalItemSet.CURRY_POWDER.getItem().get())
                .requires(CompoundIngredient.of(new Ingredient[] { Ingredient.of(TsukiItemTags.VEGETABLES),
                        Ingredient.of(TsukiItemTags.FOODS_RAW_MEAT) }))
                .requires(CompoundIngredient.of(new Ingredient[] { Ingredient.of(TsukiItemTags.VEGETABLES),
                        Ingredient.of(TsukiItemTags.FOODS_RAW_MEAT) }))
                .requires(TsukiItemTags.FLOUR)
                .requires(TsukiItemTags.DASHI)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiNormalItemSet.NOODLE_SOUP.getItem().get(), 2)
                .requires(TsukiNormalItemSet.KAESHI.getItem().get())
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.RAMEN).get(), 1)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.RAMEN_BEEF.getItem().get(), 1)
                .requires(TsukiNormalItemSet.RAMEN_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiItemTags.RAW_BEEF)
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.RAMEN_EGG.getItem().get(), 1)
                .requires(TsukiNormalItemSet.RAMEN_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiItemTags.EGGS)
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.RAMEN_FRIEDTOFU.getItem().get(), 1)
                .requires(TsukiNormalItemSet.RAMEN_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.RAMEN_KATSU.getItem().get(), 1)
                .requires(TsukiNormalItemSet.RAMEN_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.RAMEN_TEMPURA.getItem().get(), 1)
                .requires(TsukiNormalItemSet.RAMEN_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.RAMEN_FRIEDCHICKEN.getItem().get(), 1)
                .requires(TsukiNormalItemSet.RAMEN_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.RAMEN_CROQUETTE.getItem().get(), 1)
                .requires(TsukiNormalItemSet.RAMEN_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.RAMEN_LARGE.getItem().get(), 1)
                .requires(TsukiNormalItemSet.RAMEN_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiItemTags.FOODS_RAW_MEAT)
                .requires(TsukiItemTags.VEGETABLES)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.UDON).get(), 1)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.UDON_BEEF.getItem().get(), 1)
                .requires(TsukiNormalItemSet.UDON_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiItemTags.RAW_BEEF)
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.UDON_EGG.getItem().get(), 1)
                .requires(TsukiNormalItemSet.UDON_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiItemTags.EGGS)
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.UDON_FRIEDTOFU.getItem().get(), 1)
                .requires(TsukiNormalItemSet.UDON_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiFoodSet.TOFU_FRIED.getItem().get())
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.UDON_KATSU.getItem().get(), 1)
                .requires(TsukiNormalItemSet.UDON_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiFoodSet.KATSU.getItem().get())
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.UDON_TEMPURA.getItem().get(), 1)
                .requires(TsukiNormalItemSet.UDON_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiFoodSet.TEMPURA.getItem().get())
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.UDON_FRIEDCHICKEN.getItem().get(), 1)
                .requires(TsukiNormalItemSet.UDON_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiFoodSet.FRIED_CHICKEN.getItem().get())
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.UDON_CROQUETTE.getItem().get(), 1)
                .requires(TsukiNormalItemSet.UDON_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiFoodSet.CROQUETTE.getItem().get())
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.UDON_LARGE.getItem().get(), 1)
                .requires(TsukiNormalItemSet.UDON_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiItemTags.FOODS_RAW_MEAT)
                .requires(TsukiItemTags.VEGETABLES)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.SOBA).get(), 1)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.SOBA_BEEF.getItem().get(), 1)
                .requires(TsukiNormalItemSet.SOBA_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiItemTags.RAW_BEEF)
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.SOBA_EGG.getItem().get(), 1)
                .requires(TsukiNormalItemSet.SOBA_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiItemTags.EGGS)
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.SOBA_FRIEDTOFU.getItem().get(), 1)
                .requires(TsukiNormalItemSet.SOBA_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiFoodSet.TOFU_FRIED.getItem().get())
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.SOBA_KATSU.getItem().get(), 1)
                .requires(TsukiNormalItemSet.SOBA_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiFoodSet.KATSU.getItem().get())
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.SOBA_TEMPURA.getItem().get(), 1)
                .requires(TsukiNormalItemSet.SOBA_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiFoodSet.TEMPURA.getItem().get())
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.SOBA_FRIEDCHICKEN.getItem().get(), 1)
                .requires(TsukiNormalItemSet.SOBA_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiFoodSet.FRIED_CHICKEN.getItem().get())
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.SOBA_CROQUETTE.getItem().get(), 1)
                .requires(TsukiNormalItemSet.SOBA_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiFoodSet.CROQUETTE.getItem().get())
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.SOBA_LARGE.getItem().get(), 1)
                .requires(TsukiNormalItemSet.SOBA_RAW.getItem().get())
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .requires(TsukiItemTags.FOODS_RAW_MEAT)
                .requires(TsukiItemTags.VEGETABLES)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.FOOD_OIL, 125),
                        TsukiCuisineSet.YAKI_UDON.getItem().get(), 1)
                .requires(TsukiNormalItemSet.UDON_RAW.getItem().get())
                .requires(TsukiNormalItemSet.KAESHI.getItem().get())
                .requires(TsukiNormalItemSet.WORCESTER_SAUCE.getItem().get())
                .requires(TsukiItemTags.VEGETABLES)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.PASTA_TOMATO).get(), 1)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.PASTA_MUSHROOM).get(), 1)
                .requires(TsukiNormalItemSet.PASTA_RAW.getItem().get())
                .requires(TsukiItemTags.MUSHROOMS)
                .requires(TsukiItemTags.MUSHROOMS)
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.PASTA_WHITESAUCE).get(), 1)
                .requires(TsukiNormalItemSet.PASTA_RAW.getItem().get())
                .requires(TsukiItemTags.MILK)
                .requires(TsukiItemTags.FLOUR)
                .requires(TsukiItemTags.SALT)
        ...
        CookingPotRecipeBuilder.cooking(
                ...
                FoodRegistry.CUISINES.get(TsukiCuisineSet.YAKI_PASTA).get(), 2)
                .requires(TsukiNormalItemSet.PASTA_RAW.getItem().get())
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                TsukiNormalItemSet.WORCESTER_SAUCE.getItem().get(), 2)
                .requires(TsukiItemTags.SUGAR)
                .requires(TsukiItemTags.FRUITS)
                .requires(TsukiItemTags.SOYSAUCE)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.FOOD_OIL, 125),
                FoodRegistry.FOODSET.get(TsukiFoodSet.TOFU_FRIED).get(), 2)
        ...
        CookingPotRecipeBuilder.cooking(
                ...
                FoodRegistry.FOODSET.get(TsukiFoodSet.KAMABOKO).get(), 2)
                .requires(TsukiItemTags.SALT)
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.SURIMI).get())
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "kamaboko_cooking"));
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 125),
                FoodRegistry.FOODSET.get(TsukiFoodSet.HYOROGAN).get(), 2)
                .requires(TsukiItemTags.FLOUR)
                .requires(TsukiNormalItemSet.RICE.getItem().get())
                .requires(Ingredient.fromValues(
                        Stream.of(new TagValue(TsukiItemTags.CROPS_TARO), new TagValue(Tags.Items.CROPS_POTATO))))
                .requires(TsukiItemTags.SUGAR)
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "hyorogan_cooking"));
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.FOOD_OIL, 125),
                FoodRegistry.FOODSET.get(TsukiFoodSet.SATSUMAAGE).get(), 2)
                .requires(TsukiItemTags.SALT)
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.SURIMI).get())
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "satsumaage_cooking"));
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.FOOD_OIL, 125),
                        FoodRegistry.FOODSET.get(TsukiFoodSet.KATSU).get(), 2)
                .requires(TsukiItemTags.RAW_PORK)
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.BREADCRUMBS).get())
                .requires(TsukiItemTags.EGGS)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.FOOD_OIL, 125),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.CHICKEN_NANBAN).get(), 2)
                .requires(TsukiFoodSet.FRIED_CHICKEN.getItem().get())
                .requires(TsukiNormalItemSet.KAESHI.getItem().get())
                .requires(TsukiFoodSet.MAYONAISE.getItem().get())
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.FOOD_OIL, 125),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.TOFU_NANBAN).get(), 2)
                .requires(TsukiFoodSet.TOFU_FRIED.getItem().get())
                .requires(TsukiNormalItemSet.KAESHI.getItem().get())
                .requires(TsukiFoodSet.MAYONAISE.getItem().get())
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.FOOD_OIL, 125),
                FoodRegistry.FOODSET.get(TsukiFoodSet.FRIED_CHICKEN).get(), 2)
                .requires(TsukiItemTags.RAW_CHICKEN)
                .requires(
                        Ingredient.fromValues(
                                Stream.of(
                                        new ItemValue(new ItemStack(
                                                FoodRegistry.FOODSET.get(TsukiFoodSet.BREADCRUMBS).get())),
                                        new TagValue(TsukiItemTags.FLOUR))))
                .requires(TsukiItemTags.EGGS)
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "fried_chicken_cooking"));
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.FOOD_OIL, 125),
                FoodRegistry.FOODSET.get(TsukiFoodSet.CROQUETTE).get(), 2)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                ItemRegistry.MATERIALS.get(TsukiNormalItemSet.KAESHI).get(), 4)
                .requires(TsukiItemTags.SUGAR)
                .requires(TsukiItemTags.SOYSAUCE)
                .requires(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.MIRIN).get())
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 125),
                FoodRegistry.FOODSET.get(TsukiFoodSet.FISHCAKE).get(), 4)
                .requires(TsukiItemTags.SALT)
                .requires(TsukiItemTags.EGGS)
                .requires(Ingredient.fromValues(
                        Stream.of(new TagValue(TsukiItemTags.CROPS_TARO), new TagValue(Tags.Items.CROPS_POTATO))))
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.SOUP_REDBEAN).get(), 2)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 125),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.CABBAGE_ROLL).get())
                .requires(TsukiItemTags.SALAD_INGREDIENTS_CABBAGE)
                .requires(
                        Ingredient.fromValues(
                                Stream.of(
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 125),
                FoodRegistry.FOODSET.get(TsukiFoodSet.REDBEAN_PASTE).get(), 2)
                .requires(TsukiItemTags.CROPS_REDBEAN)
                .requires(TsukiItemTags.CROPS_REDBEAN)
                .requires(TsukiItemTags.SUGAR)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.FOOD_OIL, 125),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.MABODOFU).get(), 2)
                .requires(TsukiFoodSet.TOFU.getItem().get())
                .requires(TsukiFoodSet.MINCED_MEAT.getItem().get())
                .requires(TsukiItemTags.SOYSAUCE)
                .requires(TsukiItemTags.VEGETABLES)
                .container(Items.BOWL)
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "mabodofu_cooking"));
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.FOOD_OIL, 125),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.MABOQIEZI).get(), 2)
                .requires(TsukiFoodSet.EGGPLANT.getItem().get())
                .requires(TsukiFoodSet.MINCED_MEAT.getItem().get())
                .requires(TsukiItemTags.SOYSAUCE)
                .requires(TsukiItemTags.VEGETABLES)
                .container(Items.BOWL)
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "maboqiezi_cooking"));
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.FOODSET.get(TsukiFoodSet.TOMATO_SAUCE).get(), 2)
                .requires(TsukiItemTags.CROPS_TOMATO)
                .requires(TsukiItemTags.CROPS_TOMATO)
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "tomato_sauce_cooking"));
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 125),
                FoodRegistry.FOODSET.get(TsukiFoodSet.DANGO).get(), 2)
                .requires(TsukiItemTags.DOUGH_RICE)
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "dango_cooking"));
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 125),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.DANANKO).get())
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 125),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.DANMITARASHI).get())
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.DANGO).get())
                .requires(TsukiItemTags.SUGAR)
                .requires(TsukiItemTags.SUGAR)
                .container(TsukiNormalItemSet.BAMBOO.getItem().get())
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 125),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.DANSANSYOKU).get())
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.DANGO).get())
                .requires(BlockRegistry.SAKURA_LEAVES.get())
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 125),
                FoodRegistry.FOODSET.get(TsukiFoodSet.DAIFUKU).get(), 2)
                .requires(TsukiItemTags.DOUGH_RICE)
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.REDBEAN_PASTE).get())
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "daifuku_cooking"));
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 125),
                FoodRegistry.FOODSET.get(TsukiFoodSet.KUSA_DAIFUKU).get(), 2)
                .requires(TsukiItemTags.DOUGH_RICE)
                .requires(Items.SHORT_GRASS)
                .requires(FoodRegistry.FOODSET.get(TsukiFoodSet.REDBEAN_PASTE).get())
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 125), TsukiFoodSet.OHAGI.getItem().get())
        ...
        CookingPotRecipeBuilder.cooking(
                ...
                .requires(TsukiNormalItemSet.RICE.getItem().get())
                .requires(DifferenceIngredient.of(
                        Ingredient.of(TsukiItemTags.MUSHROOMS),
                        Ingredient.of(FoodRegistry.FOODSET.get(TsukiFoodSet.MATSUTAKE).get())))
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder.cooking(
                ...
                .requires(TsukiFoodSet.BURGER.getItem().get())
                .container(Items.BOWL)
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "cooking/rice_curry_cheese_burger"));
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 125),
        ...
        CookingPotRecipeBuilder
                ...
                .requires(TsukiNormalItemSet.CURRY_SAUCE.getItem().get())
                .container(Items.BOWL)
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "cooking/curry_omurice"));
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.FOOD_OIL, 125),
                        FoodRegistry.FOODSET.get(TsukiFoodSet.TEMPURA).get())
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.OSUIMONO).get(), 2)
                .requires(Items.DRIED_KELP)
                .requires(TsukiItemTags.SOYSAUCE)
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.SOUP_MISO).get(), 2)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 125),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.NIKUJAGA).get(), 2)
                .requires(Ingredient.fromValues(
                        Stream.of(new TagValue(TsukiItemTags.RAW_PORK), new TagValue(TsukiItemTags.RAW_BEEF))))
                .requires(Tags.Items.CROPS_CARROT)
                .requires(Tags.Items.CROPS_POTATO)
                .requires(TsukiItemTags.SOYSAUCE)
                .requires(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.MIRIN).get())
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.NIMONO_PUMPKIN).get(), 2)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.NIMONO_RADISH).get(), 2)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.IMOTAKI).get(), 2)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.CHIKUZENNI).get(), 2)
                .requires(TsukiItemTags.RAW_CHICKEN)
                .requires(TsukiItemTags.MUSHROOMS)
                .requires(TsukiItemTags.VEGETABLES)
                .requires(TsukiItemTags.SOYSAUCE)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.NOPPEI_JIRU).get(), 2)
                .requires(TsukiItemTags.RAW_CHICKEN)
                .requires(TsukiItemTags.CROPS_TARO)
                .requires(TsukiItemTags.VEGETABLES)
                .requires(TsukiItemTags.SOYSAUCE)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.NIMONO_FISH).get(), 2)
                .requires(TsukiItemTags.RAW_FISHES)
                .requires(TsukiItemTags.MISO)
                .requires(TsukiItemTags.SALT)
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 125),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.FUROFUKI_DAIKON).get(), 2)
                .requires(TsukiItemTags.CROPS_RADISH)
                .requires(TsukiItemTags.MISO)
                .requires(TsukiItemTags.SALT)
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder.cooking(
                ...
                ItemRegistry.MATERIALS.get(TsukiNormalItemSet.DASHI).get(), 1)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.FOOD_OIL, 125),
                        FoodRegistry.FOODSET.get(TsukiFoodSet.YAKINIKU).get())
                .requires(
                        Ingredient.fromValues(
                                Stream.of(new TagValue(TsukiItemTags.RAW_PORK), new TagValue(TsukiItemTags.RAW_BEEF),
                                        new TagValue(TsukiItemTags.RAW_MUTTON))))
        ...
        CookingPotRecipeBuilder.cooking(
                ...
                FoodRegistry.FOODSET.get(TsukiFoodSet.EGG_SOFT).get(), 2)
                .requires(TsukiItemTags.EGGS)
                .requires(TsukiItemTags.EGGS)
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "egg_soft_cooking"));
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 200),
                FoodRegistry.FOODSET.get(TsukiFoodSet.EGG_SOYSAUCE).get(), 2)
                .requires(TsukiItemTags.EGGS)
                .requires(TsukiItemTags.EGGS)
                .requires(TsukiItemTags.SOYSAUCE)
                .requires(TsukiItemTags.SUGAR)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 200),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.CHAWANMUSHI).get(), 2)
                .requires(TsukiItemTags.EGGS)
                .requires(TsukiItemTags.VEGETABLES)
                .requires(TsukiNormalItemSet.NOODLE_SOUP.getItem().get())
                .container(Items.BOWL)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 200),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.WHITE_STEW).get(), 2)
                .requires(TsukiItemTags.MILK)
                .requires(TsukiItemTags.FLOUR)
                .requires(TsukiItemTags.SALT)
                .requires(TsukiItemTags.RAW_CHICKEN)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 200),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.ODEN).get(), 2)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 200),
                FoodRegistry.FOODSET.get(TsukiFoodSet.PUDDING).get(), 2)
                .requires(TsukiItemTags.MILK)
                .requires(TsukiItemTags.SUGAR)
                .requires(TsukiItemTags.EGGS)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 200),
                FoodRegistry.FOODSET.get(TsukiFoodSet.PUDDING_MAPLE).get(), 2)
                .requires(TsukiItemTags.MILK)
                .requires(TsukiItemTags.SUGAR)
                .requires(TsukiItemTags.EGGS)
                .requires(TsukiNormalItemSet.VANILLA.getItem().get())
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 200),
                FoodRegistry.FOODSET.get(TsukiFoodSet.PUDDING_MOCHA).get(), 2)
                .requires(TsukiItemTags.MILK)
                .requires(TsukiItemTags.SUGAR)
                .requires(TsukiItemTags.EGGS)
                .requires(TsukiNormalItemSet.VANILLA.getItem().get())
        ...
        CookingPotRecipeBuilder.cooking(
                ...
                FoodRegistry.FOODSET.get(TsukiFoodSet.FRUITSALAD).get(), 2)
                .requires(TsukiItemTags.FRUITS_APPLE)
                .requires(TsukiItemTags.SUGAR)
                .requires(TsukiItemTags.FRUITS)
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "fruitsalad_cooking"));
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.FOOD_OIL, 200),
                FoodRegistry.CUISINES.get(TsukiCuisineSet.YAKI_SOBA).get(), 2)
                .requires(TsukiNormalItemSet.SOBA_RAW.getItem().get())
                .requires(TsukiItemTags.FOODS_RAW_MEAT)
                .requires(TsukiItemTags.VEGETABLES)
                .requires(TsukiItemTags.SOYSAUCE)
        ...
        CookingPotRecipeBuilder.cooking(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 0),
                FoodRegistry.FOODSET.get(TsukiFoodSet.SUIKATSUGAN).get(), 2)
                .requires(TsukiItemTags.FLOUR)
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.RAMEN_CURRY.getItem().get(), 1)
                .requires(TsukiNormalItemSet.RAMEN_RAW.getItem().get())
                .requires(TsukiNormalItemSet.DASHI.getItem().get())
                .requires(CompoundIngredient.of(new Ingredient[] { Ingredient.of(TsukiItemTags.VEGETABLES),
                        Ingredient.of(TsukiItemTags.FOODS_RAW_MEAT) }))
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.UDON_CURRY.getItem().get(), 1)
                .requires(TsukiNormalItemSet.UDON_RAW.getItem().get())
                .requires(TsukiNormalItemSet.DASHI.getItem().get())
                .requires(CompoundIngredient.of(new Ingredient[] { Ingredient.of(TsukiItemTags.VEGETABLES),
                        Ingredient.of(TsukiItemTags.FOODS_RAW_MEAT) }))
        ...
        CookingPotRecipeBuilder
                .cooking(FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 250),
                        TsukiCuisineSet.SOBA_CURRY.getItem().get(), 1)
                .requires(TsukiNormalItemSet.SOBA_RAW.getItem().get())
                .requires(TsukiNormalItemSet.DASHI.getItem().get())
                .requires(CompoundIngredient.of(new Ingredient[] { Ingredient.of(TsukiItemTags.VEGETABLES),
                        Ingredient.of(TsukiItemTags.FOODS_RAW_MEAT) }))
    ...
    private void registerFermenterRecipe(RecipeOutput consumer) {
        ...
        FermenterRecipeBuilder
                .fermenting(FluidIngredient.EMPTY, FoodRegistry.FOODSET.get(TsukiFoodSet.NATTO).get(), 2,
                        FluidStack.EMPTY, 0.0F, 600)
                .requires(TsukiItemTags.CROPS_SOYBEAN)
                .requires(TsukiItemTags.STRAW)
    ...
    private void registerDistillerRecipe(RecipeOutput consumer) {
        ...
        DistillerRecipeBuilder.distillation(
                ...
                .requires(ItemRegistry.MATERIALS.get(TsukiNormalItemSet.SAKE_KASU).get())
                .save(consumer,
                        ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "shouchu_from_sakekasu_distillation"));
        DistillerRecipeBuilder.distillation(
                FluidIngredient.fromTag(TsukiFluidTags.WATER_WATER, 1000),
        ...
        DistillerRecipeBuilder.distillation(
                ...
                .requires(TsukiItemTags.CROPS_COCOA_BEAN)
                .requires(TsukiItemTags.CROPS_VANILLA)
    ...
    private void registerDrinkRecipes(RecipeOutput consumer) {
        ...
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, DrinkRegistry.ALCOHOLS.get(TsukiAlcoholSet.GLASS_BEER).get())
    ...
    private void registerCocktailCraftRecipes(RecipeOutput consumer) {
        ...
        ItemLike collinsGlass = DrinkRegistry.COLLINS_GLASS.get();
        ...
        // ItemLike cocoaLiqueur =
        // DrinkRegistry.ALCOHOLS.get(TsukiAlcoholSet.GLASS_COCOA_LIQUEUR).get();
        ...
        // TODO: Make cocktail remain their container and add container in all the
        // shapeless recipes.
        // TODO: Add Stir.
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_KIR).get())
                .requires(whiteWine)
        ...
        // "glass_moscow_mule"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_BOILERMAKER).get(), 2)
        // .requires(whiskey)
        // .requires(beer)
        // .requires(iceCube)
        // .unlockedBy("has_item", has(whiskey))
        ...
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC,
                        DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_TEQUILA_SUNRISE).get())
                .requires(tequila)
                .requires(orangeJuice)
                .requires(blackcurrantJuice)
                .requires(iceCube)
        ...
        // "glass_margarita"));
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_CUBA_LIBRE).get())
                .requires(rum)
                .requires(cola)
                .requires(lime)
                .requires(iceCube)
        ...
        // TODO: Stir
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_AMERICANO).get())
        ...
        // "glass_negroni"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_ALEXANDER).get(), 3)
        // .requires(brandy)
        ...
        // "glass_alexander"));
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_BELLINI).get())
                .requires(champagne)
                .requires(orangeJuice)
                .requires(sugar)
                .requires(iceCube)
        ...
        // "glass_black_russian"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_GODFATHER).get(), 2)
        // .requires(whiskey)
        // .requires(liqueur)
        // .requires(almond)
        // .requires(iceCube)
        ...
        // "glass_godfather"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_GODMOTHER).get(), 2)
        // .requires(vodka)
        // .requires(liqueur)
        // .requires(almond)
        // .requires(iceCube)
        ...
        // "glass_godmother"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_SIDECAR).get(), 2)
        // .requires(brandy)
        // .requires(liqueur)
        // .requires(lemonJuice)
        // .requires(iceCube)
        ...
        // TODO: Stir
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_BLOODY_MARY).get())
                .requires(vodka)
                .requires(tomatoSauce)
                .requires(lemonJuice)
                .requires(worcesterSauce)
                .requires(salt)
                .requires(TsukiNormalItemSet.BLACK_PEPPER.getItem().get())
                .requires(iceCube)
        ...
        // "glass_rusty_nail"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_SAKETINI).get(), 2)
        // .requires(sake)
        // .requires(gin)
        // .requires(iceCube)
        ...
        // "glass_saketini"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_STINGER).get(), 2)
        // .requires(brandy)
        // .requires(liqueur)
        // .requires(mint)
        // .requires(iceCube)
        ...
        // "glass_stinger"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_SCORPION).get(), 2)
        // .requires(brandy)
        // .requires(rum)
        // .requires(orangeJuice)
        // .requires(lemonJuice)
        ...
        // "glass_scorpion"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_AVIATION).get(), 3)
        // .requires(gin)
        // .requires(liqueur)
        // .requires(liqueur)
        // .requires(lemonJuice)
        ...
        // "glass_aviation"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_BEER_MARGARITA).get(), 3)
        // .requires(tequila)
        // .requires(liqueur)
        // .requires(beer)
        // .requires(limeJuice)
        ...
        // .unlockedBy("has_item", has(tequila))
        // .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID,
        // "glass_beer_margarita"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_BETWEEN_THE_SHEETS).get(),
        // 3)
        // .requires(rum)
        // .requires(brandy)
        // .requires(liqueur)
        ...
        // .unlockedBy("has_item", has(rum))
        // .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID,
        // "glass_between_the_sheets"));
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_EGGNOG).get())
                .requires(brandy)
                .requires(milk)
                .requires(egg)
                .requires(sugar)
        ...
        // .unlockedBy("has_item", has(vodka))
        // .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID,
        // "glass_flying_grasshopper"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_FRENCH_SEVENFIVE).get(),
        // 2)
        // .requires(gin)
        // .requires(champagne)
        // .requires(lemonJuice)
        ...
        // .unlockedBy("has_item", has(gin))
        // .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID,
        // "glass_french_sevenfive"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_GRASSHOPPER).get(), 2)
        // .requires(liqueur)
        // .requires(cocoaLiqueur)
        // .requires(mint)
        // .requires(milk)
        ...
        // "glass_grasshopper"));
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_JOHN_COLLINS).get())
                .requires(gin)
                .requires(lemonJuice)
                .requires(sugar)
                .requires(sodaWater)
        ...
        // .unlockedBy("has_item", has(tequila))
        // .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID,
        // "glass_lemon_margarita"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_LONG_ISLAND_ICED_TEA).get())
        // .requires(rum)
        // .requires(gin)
        // .requires(vodka)
        // .requires(tequila)
        ...
        // .unlockedBy("has_item", has(vodka))
        // .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID,
        // "glass_long_island_iced_tea"));
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.MISC, DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_MINT_JULEP).get())
                .requires(whiskey)
                .requires(sugar)
                .requires(mint)
                .requires(bitters)
        ...
        // "glass_paradise"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_PORCHCRAWLER).get())
        // .requires(vodka)
        // .requires(beer)
        // .requires(lemonJuice)
        // .requires(iceCube)
        ...
        // .unlockedBy("has_item", has(whiskey))
        // .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID,
        // "glass_porchcrawler_whiskey"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_PORTO_FLIP).get())
        // .requires(brandy)
        // .requires(redWine)
        // .requires(egg)
        // .requires(sugar)
        ...
        // "glass_porto_flip"));
        // ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC,
        // DrinkRegistry.COCKTAILS.get(TsukiCocktailSet.GLASS_RUSSIAN_SPRING).get())
        // .requires(vodka)
        // .requires(champagne)
        // .requires(blackcurrantJuice)
        // .requires(lemonJuice)
    ...
    private void registerChoppingRecipes(RecipeOutput consumer) {
        ChoppingBoardRecipeBuilder.chop(FoodRegistry.FOODSET.get(TsukiFoodSet.MACHINED_FISH).get())
                .requires(
                        Ingredient.fromValues(
                                Stream.of(new ItemValue(new ItemStack(Items.COD)),
                                        new ItemValue(new ItemStack(Items.SALMON)),
                                        new ItemValue(new ItemStack(Items.TROPICAL_FISH)))))
        ...
        ChoppingBoardRecipeBuilder.chop(TsukiNormalItemSet.ICE_CUBE.getItem().get(), 8)
                .requires(Items.ICE)
                .requiresTool(TsukiItemTags.AXES)
                .save(consumer, ResourceLocation.fromNamespaceAndPath(Tsuki.MODID, "ice_cube_chopping"));
    }
    ...
    private void foodSmeltingRecipes(String name, ItemLike ingredient, ItemLike result, float experience,
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ingredient), RecipeCategory.FOOD, result, experience, 200)
                ...
                .save(consumer);
        SimpleCookingRecipeBuilder
                .campfireCooking(Ingredient.of(ingredient), RecipeCategory.FOOD, result, experience, 600)
                .unlockedBy("has_ingredient", has(ingredient))
                .group(Tsuki.MODID)
    ...
    public ShapedRecipeBuilder makeLumberToPlank(Supplier<? extends Block> blockOut, Ingredient ingreIn) {
        return ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, blockOut.get()).pattern("##").pattern("##")
                .define('#', ingreIn);
    }
    ...
    public ShapelessRecipeBuilder makeBlockToIngot(Supplier<? extends Item> result,
