...
public class ecru_EntityAIPamFruitHarvest extends EntityAIBase {
    ...
    public ecru_EntityAIPamFruitHarvest(ecru_EntityMomiji pEntity, float pmoveSpeed, int bit) {
    ...
    public boolean func_75250_a() {
        if ((this.entityMomiji.getAttackMode() == 0 || !this.entityMomiji.attackModeHarvest) && this.entityMomiji.isTamed() && !this.entityMomiji.isSitting() && this.entityMomiji.isFreedom() && !this.entityMomiji.field_70128_L && this.entityMomiji.getShears() != -1 && !this.entityMomiji.func_70631_g_() && this.entityMomiji.getInventoryFull() != -1) {
    ...
    public void func_75249_e() {
        GameProfile gp = new GameProfile(UUID.randomUUID(), "PamFruitHarvest");
    ...
    private boolean checkBlock(int x, int y, int z) {
        if (!this.worldObject.func_147437_c(x, y, z) && this.worldObject.func_147439_a(x, y, z).getClass().getSimpleName().equals("BlockPamFruit") && (this.worldObject.func_147439_a(x, y, z) instanceof Block) && (this.worldObject.func_72805_g(x, y, z) & 7) >= 2) {
            return true;
        }
        return false;
    }
