...
public class LighthouseIlluminationGeoModel extends GeoModel<LighthouseIlluminationBlockEntity> {
    ...
    @Override
    public ResourceLocation getModelResource(LighthouseIlluminationBlockEntity animatable) {
        return MODEL;
    }

    @Override
    public ResourceLocation getTextureResource(LighthouseIlluminationBlockEntity animatable) {
        return TEXTURE;
    }

    @Override
    public ResourceLocation getAnimationResource(LighthouseIlluminationBlockEntity animatable) {
        return ANIMATION;
    }
    ...
    public void setCustomAnimations(LighthouseIlluminationBlockEntity entity, long instanceId,
        ...
        if (upper == null || entity.getLevel() == null)
            return;
