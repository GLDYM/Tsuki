...
public class TsukiBlockTags {
    ...
    public static final TagKey<Block> STRIPPED_LOG = TagUtils.forgeBlockTag("stripped_logs");
    public static final TagKey<Block> STRIPPED_WOOD = TagUtils.forgeBlockTag("stripped_woods");
    ...
    public static final TagKey<Block> MINEABLE_WITH_KNIFE = TagUtils.forgeBlockTag("mineable/knife");
