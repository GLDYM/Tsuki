...
public class ecru_BlockPersimmonLeaves extends BlockLeavesBase implements IShearable {
    int[] field_150128_a;
    ...
    public ecru_BlockPersimmonLeaves() {
    ...
    public Item func_149650_a(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
        return Item.func_150898_a(mod_ecru_MapleTree.blockPersimmonSapling);
    }
    ...
    public boolean func_149646_a(IBlockAccess iblockaccess, int i, int j, int k, int l) {
        ...
        if (mod_ecru_MapleTree.GraphicsLevel == 1) {
            if (i1 == mod_ecru_MapleTree.blockPersimmonLeaves) {
                return false;
            }
            return _shouldSideBeRendered(iblockaccess, i, j, k, l);
        }
        if (Blocks.field_150362_t.func_149662_c() && i1 == mod_ecru_MapleTree.blockPersimmonLeaves) {
            return false;
        }
        return _shouldSideBeRendered(iblockaccess, i, j, k, l);
    }
    ...
    public void func_149689_a(World world, int i, int j, int k, EntityLivingBase entityliving, ItemStack par6ItemStack) {
        ...
        if (id == mod_ecru_MapleTree.blockPersimmonLeaves) {
    ...
    public void func_149651_a(IIconRegister par1IconRegister) {
        this.tx_leaves[0] = par1IconRegister.func_94245_a("mapletree:persimmonLeaves0");
        this.tx_leaves[1] = par1IconRegister.func_94245_a("mapletree:persimmonLeaves_fast0");
        this.tx_leaves[2] = par1IconRegister.func_94245_a("mapletree:persimmonLeaves1");
        this.tx_leaves[3] = par1IconRegister.func_94245_a("mapletree:persimmonLeaves_fast1");
        this.tx_leaves[4] = par1IconRegister.func_94245_a("mapletree:persimmonLeaves2");
        this.tx_leaves[5] = par1IconRegister.func_94245_a("mapletree:persimmonLeaves_fast2");
        this.tx_leaves[6] = par1IconRegister.func_94245_a("mapletree:persimmonLeaves3");
        this.tx_leaves[7] = par1IconRegister.func_94245_a("mapletree:persimmonLeaves_fast3");
    }
}
