...
public class ecru_ModelSLight extends ModelBase {
    ModelRenderer Base1;
    ModelRenderer Light;
    ModelRenderer Body1;
    ModelRenderer Body2;
    ...
    public ecru_ModelSLight() {
        this.field_78090_t = 64;
        this.field_78089_u = 32;
        this.Base1 = new ModelRenderer(this, 56, 3);
        this.Base1.func_78789_a(0.0f, -1.0f, -1.5f, 1, 5, 3);
        this.Base1.func_78793_a(7.0f, 12.0f, 0.0f);
        ...
        this.Light.func_78789_a(-1.0f, 0.0f, -1.0f, 2, 3, 2);
        this.Light.func_78793_a(3.0f, 13.0f, 0.0f);
        this.Light.func_78787_b(64, 32);
        this.Light.field_78809_i = true;
        setRotation(this.Light, 0.0f, 0.0f, 0.6981317f);
        this.Body1 = new ModelRenderer(this, 0, 0);
        this.Body1.func_78789_a(-3.0f, 0.0f, -3.0f, 1, 4, 6);
        this.Body1.func_78793_a(3.0f, 13.0f, 0.0f);
        this.Body1.func_78787_b(64, 32);
        this.Body1.field_78809_i = true;
        setRotation(this.Body1, 0.0f, 0.0f, 0.6981317f);
        this.Body2 = new ModelRenderer(this, 15, 0);
        this.Body2.func_78789_a(2.0f, 0.0f, -3.0f, 1, 4, 6);
        this.Body2.func_78793_a(3.0f, 13.0f, 0.0f);
        this.Body2.func_78787_b(64, 32);
        this.Body2.field_78809_i = true;
        setRotation(this.Body2, 0.0f, 0.0f, 0.6981317f);
        this.Body3 = new ModelRenderer(this, 0, 12);
        this.Body3.func_78789_a(-2.0f, 0.0f, -3.0f, 4, 4, 1);
        this.Body3.func_78793_a(3.0f, 13.0f, 0.0f);
        this.Body3.func_78787_b(64, 32);
        this.Body3.field_78809_i = true;
        setRotation(this.Body3, 0.0f, 0.0f, 0.6981317f);
        this.Body4 = new ModelRenderer(this, 11, 12);
        this.Body4.func_78789_a(-2.0f, 0.0f, 2.0f, 4, 4, 1);
        this.Body4.func_78793_a(3.0f, 13.0f, 0.0f);
        this.Body4.func_78787_b(64, 32);
        this.Body4.field_78809_i = true;
        setRotation(this.Body4, 0.0f, 0.0f, 0.6981317f);
        this.Body0 = new ModelRenderer(this, 0, 26);
        this.Body0.func_78789_a(-2.5f, -1.0f, -2.5f, 5, 1, 5);
        this.Body0.func_78793_a(3.0f, 13.0f, 0.0f);
        this.Body0.func_78787_b(64, 32);
        this.Body0.field_78809_i = true;
        setRotation(this.Body0, 0.0f, 0.0f, 0.6981317f);
        this.Base2 = new ModelRenderer(this, 52, 0);
        this.Base2.func_78789_a(-5.0f, -0.5f, -0.5f, 5, 1, 1);
        this.Base2.func_78793_a(3.0f, 13.0f, 0.0f);
        this.Base2.func_78787_b(64, 32);
        this.Base2.field_78809_i = true;
        setRotation(this.Base2, 0.0f, 0.0f, -2.998558f);
    }
