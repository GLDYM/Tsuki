...
public class ecru_ItemNormal extends Item {
    private String itemName;
    IIcon[] iIcon;

    public ecru_ItemNormal(String str) {
        func_77627_a(true);
        func_77656_e(0);
        this.itemName = str;
        func_77655_b(str);
    ...
    public void func_94581_a(IIconRegister par1IconRegister) {
        ecru_itemNormalList.itemNormalList[] inl = ecru_itemNormalList.itemNormalList.values();
        this.iIcon = new IIcon[inl.length];
        for (int i = 0; i < inl.length; i++) {
            this.iIcon[i] = par1IconRegister.func_94245_a(inl[i].e_itemName);
        }
    }
