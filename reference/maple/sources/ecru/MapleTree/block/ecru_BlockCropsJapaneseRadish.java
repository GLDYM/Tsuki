...
public class ecru_BlockCropsJapaneseRadish extends BlockCrops {
    public static IIcon tx_japaneseRadish;
    public static IIcon tx_leaf;
    public static IIcon[] tx_leaf_ex;
    private Random random = new Random();

    public ecru_BlockCropsJapaneseRadish() {
        func_149675_a(true);
    }
    ...
    protected Item func_149866_i() {
        return mod_ecru_MapleTree.Item_japaneseRadishSeeds;
    }
    ...
    public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune) {
        ...
        if (metadata >= 7) {
            ret.add(new ItemStack(func_149865_P(), 1, 10));
    ...
    public void func_149719_a(IBlockAccess par1IBlockAccess, int i, int j, int k) {
        if (par1IBlockAccess.func_72805_g(i, j, k) >= 0 && par1IBlockAccess.func_72805_g(i, j, k) <= 3) {
    ...
    public IIcon getJapaneseRadishIcon(int i) {
        return tx_japaneseRadish;
    }
    ...
    public int getJapaneseRadishNum(int i) {
        int num = 0;
        if (i >= 5 && i <= 7) {
            num = i - 5;
        }
    ...
    public void func_149651_a(IIconRegister par1IconRegister) {
        tx_japaneseRadish = par1IconRegister.func_94245_a("mapletree:japaneseRadishBlock");
        tx_leaf = par1IconRegister.func_94245_a("mapletree:japaneseRadishLeaf");
        tx_leaf_ex = new IIcon[3];
        tx_leaf_ex[0] = par1IconRegister.func_94245_a("mapletree:japaneseRadishLeaf_ex0");
        tx_leaf_ex[1] = par1IconRegister.func_94245_a("mapletree:japaneseRadishLeaf_ex1");
        tx_leaf_ex[2] = par1IconRegister.func_94245_a("mapletree:japaneseRadishLeaf_ex2");
    }
