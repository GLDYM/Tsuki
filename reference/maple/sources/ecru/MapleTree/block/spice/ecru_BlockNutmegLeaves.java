...
public class ecru_BlockNutmegLeaves extends ecru_BlockSpiceLeavesBase {
    ...
    public ecru_BlockNutmegLeaves() {
        super(Material.field_151584_j, false);
        this.random = new Random();
        this.tx_leaves = new IIcon[8];
        this.GrowthProbability = new int[]{30, 50, 30, 0};
    ...
    public boolean func_149727_a(World world, int i, int j, int k, EntityPlayer entityplayer, int l, float m, float n, float o) {
        ...
        if ((meta & 3) == 3) {
            dropBlockAsItemSpace(world, i, j, k, new ItemStack(mod_ecru_MapleTree.Item_nutmegFruit, 1, 0));
    ...
    public void func_149690_a(World world, int i, int j, int k, int l, float m, int n) {
        ...
        if ((l & 3) == 3) {
            func_149642_a(world, i, j, k, new ItemStack(mod_ecru_MapleTree.Item_nutmegFruit, 1, 0));
        }
    }
    ...
    public void func_149651_a(IIconRegister par1IconRegister) {
        this.tx_leaves[0] = par1IconRegister.func_94245_a("mapletree:nutmegLeaves_0");
        this.tx_leaves[1] = par1IconRegister.func_94245_a("mapletree:nutmegLeavesFast_0");
        this.tx_leaves[2] = par1IconRegister.func_94245_a("mapletree:nutmegLeaves_1");
        this.tx_leaves[3] = par1IconRegister.func_94245_a("mapletree:nutmegLeavesFast_1");
        this.tx_leaves[4] = par1IconRegister.func_94245_a("mapletree:nutmegLeaves_2");
        this.tx_leaves[5] = par1IconRegister.func_94245_a("mapletree:nutmegLeavesFast_2");
        this.tx_leaves[6] = par1IconRegister.func_94245_a("mapletree:nutmegLeaves_3");
        this.tx_leaves[7] = par1IconRegister.func_94245_a("mapletree:nutmegLeavesFast_3");
    }
