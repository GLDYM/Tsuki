...
public class ecru_ItemTeuchiSoba extends ItemBlockWithMetadata {
    public ecru_ItemTeuchiSoba(Block i) {
        super(i, i);
        func_77627_a(true);
        func_77656_e(0);
    ...
    public boolean func_77648_a(ItemStack itemstack, EntityPlayer entityplayer, World world, int i, int j, int k, int l, float par8, float par9, float par10) {
        ...
        if (!world.field_72995_K) {
            ...
            world.func_147465_d(i, j, k, mod_ecru_MapleTree.blockTeuchiSoba, meta | direction, 3);
