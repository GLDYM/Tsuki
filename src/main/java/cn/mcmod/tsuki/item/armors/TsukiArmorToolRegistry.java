...
public class TsukiArmorToolRegistry {
    ...
    public static final DeferredItem<Item> KIMONO_WHITE = register("kimono_white",
            () -> new KimonoItem("kimono_white", TsukiArmorMaterials.KIMONO, ArmorItem.Type.CHESTPLATE, Tsuki.defaultItemProperties()));
    public static final DeferredItem<Item> KIMONO_BLACK = register("kimono_black",
            () -> new KimonoItem("kimono_black", TsukiArmorMaterials.KIMONO, ArmorItem.Type.CHESTPLATE, Tsuki.defaultItemProperties()));
    public static final DeferredItem<Item> KIMONO_BROWN = register("kimono_brown",
            () -> new KimonoItem("kimono_brown", TsukiArmorMaterials.KIMONO, ArmorItem.Type.CHESTPLATE, Tsuki.defaultItemProperties()));
    public static final DeferredItem<Item> KIMONO_GREEN = register("kimono_green",
            () -> new KimonoItem("kimono_green", TsukiArmorMaterials.KIMONO, ArmorItem.Type.CHESTPLATE, Tsuki.defaultItemProperties()));
    public static final DeferredItem<Item> KIMONO_CYAN = register("kimono_cyan",
            () -> new KimonoItem("kimono_cyan", TsukiArmorMaterials.KIMONO, ArmorItem.Type.CHESTPLATE, Tsuki.defaultItemProperties()));
    public static final DeferredItem<Item> KIMONO_PURPLE = register("kimono_purple",
            () -> new KimonoItem("kimono_purple", TsukiArmorMaterials.KIMONO, ArmorItem.Type.CHESTPLATE, Tsuki.defaultItemProperties()));
    public static final DeferredItem<Item> KIMONO_SAKURA = register("kimono_sakura",
            () -> new KimonoItem("kimono_sakura", TsukiArmorMaterials.KIMONO, ArmorItem.Type.CHESTPLATE, Tsuki.defaultItemProperties()));
    public static final DeferredItem<Item> KIMONO_MIKO = register("kimono_miko",
            () -> new KimonoItem("kimono_miko", TsukiArmorMaterials.KIMONO, ArmorItem.Type.CHESTPLATE, Tsuki.defaultItemProperties()));
    public static final DeferredItem<Item> KIMONO_ENE = register("kimono_ene",
            () -> new KimonoItem("kimono_ene", TsukiArmorMaterials.KIMONO, ArmorItem.Type.CHESTPLATE, Tsuki.defaultItemProperties()));
    public static final DeferredItem<Item> YUKATA_RED = register("yukata_red",
            () -> new KimonoItem("yukata_red", TsukiArmorMaterials.KIMONO, ArmorItem.Type.CHESTPLATE, Tsuki.defaultItemProperties()));
    public static final DeferredItem<Item> YUKATA_BLUE = register("yukata_blue",
            () -> new KimonoItem("yukata_blue", TsukiArmorMaterials.KIMONO, ArmorItem.Type.CHESTPLATE, Tsuki.defaultItemProperties()));
    public static final DeferredItem<Item> YUKATA_MAGENTA = register("yukata_magenta",
            () -> new KimonoItem("yukata_magenta", TsukiArmorMaterials.KIMONO, ArmorItem.Type.CHESTPLATE, Tsuki.defaultItemProperties()));
    public static final DeferredItem<Item> YUKATA_LIME = register("yukata_lime",
            () -> new KimonoItem("yukata_lime", TsukiArmorMaterials.KIMONO, ArmorItem.Type.CHESTPLATE, Tsuki.defaultItemProperties()));
    public static final DeferredItem<Item> YUKATA_YELLOW = register("yukata_yellow",
            () -> new KimonoItem("yukata_yellow", TsukiArmorMaterials.KIMONO, ArmorItem.Type.CHESTPLATE, Tsuki.defaultItemProperties()));
